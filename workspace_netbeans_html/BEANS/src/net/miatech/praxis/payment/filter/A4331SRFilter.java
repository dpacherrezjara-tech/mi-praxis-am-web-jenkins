...
public class A4331SRFilter {
    ...
    public Integer getTOTAL_MATCH() {
        return TOTAL_MATCH;
    }

    public void setTOTAL_MATCH(Integer TOTAL_MATCH) {
    ...
    public void setTOTAL_PENDING(Integer TOTAL_PENDING) {
        this.TOTAL_PENDING = TOTAL_PENDING;
    }

    public Integer getTOTAL_NC_MATCH() {
        return TOTAL_NC_MATCH;
    }

    public void setTOTAL_NC_MATCH(Integer TOTAL_NC_MATCH) {
        this.TOTAL_NC_MATCH = TOTAL_NC_MATCH;
    }

    public Integer getTOTAL_NC_PENDING() {
        return TOTAL_NC_PENDING;
    }

    public void setTOTAL_NC_PENDING(Integer TOTAL_NC_PENDING) {
