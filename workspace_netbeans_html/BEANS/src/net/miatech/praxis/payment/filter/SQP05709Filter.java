 ...
 * @author Yremicio
 */
public class SQP05709Filter extends CustomPageImpl{
    ...
    public void setIN_GCARD(String IN_GCARD) {
     ...
     public String getIN_ESTATUS() {
        return IN_ESTATUS;
    }

    public void setIN_ESTATUS(String IN_ESTATUS) {
        this.IN_ESTATUS = IN_ESTATUS;
    }
