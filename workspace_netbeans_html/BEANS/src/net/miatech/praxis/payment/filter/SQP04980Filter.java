 ...
 * @author Dvicente
 */
public class SQP04980Filter extends CustomPageImpl{
    ...
    transient List<A4454Filter> result = new ArrayList<>();
    ...
    public List<A4454Filter> getResult() {
        return result;
    }

    public void setResult(List<A4454Filter> result) {
        this.result = result;
    }
