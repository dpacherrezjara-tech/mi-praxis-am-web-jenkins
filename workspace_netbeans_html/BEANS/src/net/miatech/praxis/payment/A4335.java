...
public class A4335 {
    ...
    private Double SADJUST;

    public void setSadjust(Double SADJUST) {
        this.SADJUST = SADJUST;
    }

    public Double getSadjust() {
        return SADJUST;
    }
    ...
    private Double FINSAMOU;

    public void setFinsamou(Double FINSAMOU) {
        this.FINSAMOU = FINSAMOU;
    }

    public Double getFinsamou() {
        return FINSAMOU;
    }

    private Double SINSAMOU;

    public void setSinsamou(Double SINSAMOU) {
        this.SINSAMOU = SINSAMOU;
    }

    public Double getSinsamou() {
        return SINSAMOU;
    }
    ...
    private Double GROSAMOUNC;

    public void setGrosamounc(Double GROSAMOUNC) {
        this.GROSAMOUNC = GROSAMOUNC;
    }

    public Double getGrosamounc() {
        return GROSAMOUNC;
    }
    ...
    private Double FINSAMOUC;

    public void setFinsamouc(Double FINSAMOUC) {
        this.FINSAMOUC = FINSAMOUC;
    }

    public Double getFinsamouc() {
        return FINSAMOUC;
    }

    private Double SINSAMOUC;

    public void setSinsamouc(Double SINSAMOUC) {
        this.SINSAMOUC = SINSAMOUC;
    }

    public Double getSinsamouc() {
        return SINSAMOUC;
    }
