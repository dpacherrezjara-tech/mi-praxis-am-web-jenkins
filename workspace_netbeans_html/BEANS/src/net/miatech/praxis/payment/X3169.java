...
public class X3169 {
    ...
    public void setFORCESCAN(String FORCESCAN) {
        this.FORCESCAN = FORCESCAN;
    }

    public String getFORCESCAN() {
        return FORCESCAN;
    }

    private String STMANUAL;

    public void setSTMANUAL(String STMANUAL) {
        this.STMANUAL = STMANUAL;
    }

    public String getSTMANUAL() {
        return STMANUAL;
    }
