...
import net.miatech.praxis.payment.old.A2289;
/**
 *
 * @author andrea
 */
public class A2289Filter extends A2289 {
    ...
    public double totAVFOP=0; 
    public String strACARCOD=""; 
    public String strSCARCOD=""; 
