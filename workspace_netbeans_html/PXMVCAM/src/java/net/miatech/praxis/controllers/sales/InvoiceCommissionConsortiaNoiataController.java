...
import net.miatech.praxis.logic.sales.InvoiceCommissionConsortiaNoiataLogic;
...
@Controller
@Scope("request")
@RequestMapping("/InvoiceCommissionConsortiaNoiata")
public class InvoiceCommissionConsortiaNoiataController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private InvoiceCommissionConsortiaNoiataLogic logic;

    @RequestMapping(method = RequestMethod.POST)
    public String index(ModelMap map) {
        map.put("vp_serverDate", Functions.getFechaActual());
        map.put("vp_serverTime", Functions.getHoraActual());
        return "sales/InvoiceCommissionConsortiaNoiata/form_index";
    }

    @RequestMapping(value = "search")
    public @ResponseBody
    String search(ModelMap map, HttpServletRequest request) {
        //System.out.println("-------------- InvoiceCommissionConsortiaNoiata : Search-------------");
    ...
    public List<SQP00801Filter> getList(HttpServletRequest request, Boolean bExcel) {
        ...
        logic = new InvoiceCommissionConsortiaNoiataLogic();
