...
import net.miatech.praxis.logic.sales.ConsortiaContractLogic;
...
@Controller
@Scope("request")
@RequestMapping("/ConsortiaContract")
public class ConsortiaContractController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private ConsortiaContractLogic logic;

    @RequestMapping(method = RequestMethod.POST)
    public String index(ModelMap map) {
        map.put("vp_serverDate", Functions.getFechaActual());
        map.put("vp_serverTime", Functions.getHoraActual());
        return "sales/ConsortiaContract/form_index";
    }

    @RequestMapping(value = "search")
    public @ResponseBody
    String search(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- Consortia Contract : Search-------------");
    ...
    public List<SQP00790Filter> getList(HttpServletRequest request, Boolean bExcel) {
        ...
        logic = new ConsortiaContractLogic();
    ...
    String loadDataMail(ModelMap map, HttpServletRequest request) throws Exception {
        System.out.println("-------------- Consortia Contract : loadDataMail-------------");
        map.put("success", true);
        logic = new ConsortiaContractLogic();
        logic.setSession(this.serverSession.getServerSession());
    ...
    String sendMail(ModelMap map, HttpServletRequest request) throws Exception {
        System.out.println("-------------- Consortia Contract : sendMail-------------");
        map.put("success", true);
        logic = new ConsortiaContractLogic();
        logic.setSession(this.serverSession.getServerSession());
        List<SQP00794Filter> lst;
    ...
    String loadTicket(ModelMap map, HttpServletRequest request) {
        System.out.println("-------------- Consortia Contract : loadTicket-------------");
        map.put("success", true);
...
//
    ...
    void GetXLSX(HttpServletRequest request, HttpServletResponse response) {
        System.out.println("Consortia Contract : getXLSX");

        String fileNameDownload = String.format("Consortia Contract - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
        ...
        try {
            ...
            Sheet sheet = workbook.createSheet("Consortia Contract");
