...
public class RobotDisputeControlController extends BaseController {
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            RobotDisputeControlLogic logic = new RobotDisputeControlLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A3268Filter> listaData = logic.SearchDebitos(filter);

            // <editor-fold defaultstate="collapsed" desc="Estilo del Excel">
            Workbook workbook = new XSSFWorkbook();
            Sheet sheet = workbook.createSheet("RobotDisputeControl");
...
//            headerStyle.setFillForegroundColor(IndexedColors.BLUE_GREY.getIndex());
            ...
            while (iter.hasNext()) {
                ...
                CH_00.setCellValue(listaData.get(vi).A3268FREGI);
                CH_01.setCellValue(listaData.get(vi).A3268ROBOT);
                CH_02.setCellValue(listaData.get(vi).A3268PAIS);
                CH_03.setCellValue(listaData.get(vi).A3268CANT);
                CH_04.setCellValue(listaData.get(vi).A3268TOTALPAG);
                CH_05.setCellValue(listaData.get(vi).A3268STATUS);
