...
import net.miatech.praxis.logic.sales.InvoiceCommissionConsortiaContractLogic;
...
@Controller
@Scope("request")
@RequestMapping("/InvoiceCommissionConsortiaContract")
public class InvoiceCommissionConsortiaContractController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private InvoiceCommissionConsortiaContractLogic logic;

    @RequestMapping(method = RequestMethod.POST)
    public String index(ModelMap map) {
        map.put("vp_serverDate", Functions.getFechaActual());
        map.put("vp_serverTime", Functions.getHoraActual());
        return "sales/InvoiceCommissionConsortiaContract/form_index";
    }

    @RequestMapping(value = "search")
    public @ResponseBody
    String search(ModelMap map, HttpServletRequest request) {
        //System.out.println("-------------- InvoiceCommissionConsortiaContract : Search-------------");
    ...
    public List<SQP00801Filter> getList(HttpServletRequest request, Boolean bExcel) {
        ...
        logic = new InvoiceCommissionConsortiaContractLogic();
...
//        System.out.println("-------------- Invoice Commission Contract FOB : mantenimiento-------------");
