...
import net.miatech.praxis.logic.salesAudit.RfndarcUserMaintenanceFormLogic;
...
@Controller
@Scope("request")
@RequestMapping("/RfndarcUserMaintenanceForm")
public class RfndarcUserMaintenanceFormController extends BaseController{
    
private static final Logger logError = Logger.getLogger("errorLog");
    private RfndarcUserMaintenanceFormLogic logic;
    ...
    String SearchQueryRefund(ModelMap map, HttpServletRequest request) {
        ...
        A4359Filter filter = new A4359Filter();
        try{
            logic = new RfndarcUserMaintenanceFormLogic();
    ...
    String mantenimientoRfndUser(ModelMap map, HttpServletRequest request) {
        ...
        try{
            ...
            RfndarcUserMaintenanceFormLogic logic = new RfndarcUserMaintenanceFormLogic();
            logic.setSession(this.serverSession.getServerSession());
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logic = new RfndarcUserMaintenanceFormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<A4359Filter> lst = logic.SearchRefundUser(filter);

            Workbook workbook = new XSSFWorkbook();
            Sheet sheet = workbook.createSheet("Auditor ARC");
            ...
            while (iter.hasNext()) {
                ...
                CH_00.setCellValue(lst.get(vi).A4359USER);
                CH_01.setCellValue(lst.get(vi).A4359PAIS);
                CH_02.setCellValue(lst.get(vi).A4359FREGI);
                CH_03.setCellValue(lst.get(vi).A4359FALTA);
                CH_04.setCellValue(lst.get(vi).A4359FBAJA);
                CH_05.setCellValue(lst.get(vi).A4359FLAG);
            ...
            String fileNameDownload = String.format("Auditor ARC- " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
