        ...
        try {
            ...
            if (listaData.size() > 65000) {
                ...
                try {
                    ...
                    Integer vi = 0;
                    String fileName = "Search Coupons - " + Functions.getFechaActual() + ".txt";
                    ...
                    cadena = "Ticket|Type|Sale Date|Sale Country|Sale Agent|Flight Date|Flight Number|Flight Orig|Flight Dest|Flight Carrier|Flight Cabin|Use Type|Value|Curr|MXN|Rate|USD|Com|Accounting Date";
                    ...
                    for (vi = 0; vi < len; vi++) {
                        ...
                        cadena += "" + listaData.get(vi).PSVVTA + "|";//
                        cadena += "" + listaData.get(vi).AGTIA + "|";//
                        ...
                        cadena += "" + listaData.get(vi).CABI + "|";//
                        cadena += "" + listaData.get(vi).TOPUS + "|";//
                        cadena += "" + listaData.get(vi).VCPN + "|";//
                        cadena += "" + listaData.get(vi).MDACP + "|";//
                        cadena += "" + listaData.get(vi).VCPMX + "|";//
                        cadena += "" + listaData.get(vi).TCMUS + "|";//
                        cadena += "" + listaData.get(vi).VCPUS + "|";//
                        cadena += "" + listaData.get(vi).COMISI + "|";//
