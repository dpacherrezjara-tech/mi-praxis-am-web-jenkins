        ...
        try {
            ...
            if (listaData.size() > 40000) {
                ...
                try {
                    ...
                    Integer vi = 0;
                    String fileName = "Report Detail EMD Standalone - " + Functions.getFechaActual();
                    ...
                    cadena = "Valuation Date|Ticket|Seq|Roll|VCR Date|Status|RFIC|Reason Code|Free Description|Country|Agent|Sale Date|Orig|Dest|Fare Basis|Pax Type|Carrier|Accounting Date|Valuation Date|Currency|Total Value|YQ 16%|YQ 0%|Poliza Date|ID Poliza";
...
//                        cadena += "" + listaData.get(vi).RN + "|";//
                        ...
                        cadena += "" + listaData.get(vi).SEQRO + "|";//
                        cadena += "" + listaData.get(vi).descDVCR + "|";//
                        cadena += "" + listaData.get(vi).descSTVAL + "|";//
                        ...
                        cadena += "" + listaData.get(vi).AGENTE + "|";//
                        cadena += "" + listaData.get(vi).descFVTA + "|";//
                        ...
                        cadena += "" + listaData.get(vi).descFCONTS + "|";//
                        cadena += "" + listaData.get(vi).descFECVAL + "|";//
                        cadena += "" + listaData.get(vi).CURRENCY + "|";//
                        cadena += "" + listaData.get(vi).VCPN + "|";//
                        cadena += "" + listaData.get(vi).TN16 + "|";//
                        cadena += "" + listaData.get(vi).TN00 + "|";//
                        cadena += "" + listaData.get(vi).descFCONT + "|";//
                        cadena += "" + listaData.get(vi).IDCON;//
