...
import net.miatech.praxis.logic.salesAudit.download0425FormLogic;
...
@Controller
@Scope("request")
@RequestMapping("/download0425FormController")
public class download0425FormController extends BaseController {

    private static final Logger logError = Logger.getLogger("errorLog");
    private download0425FormLogic logic;

    @RequestMapping(value = "Search")
    public @ResponseBody
    String Search(ModelMap map, HttpServletRequest request) {
        List<SQP00977Filter> lst;
        SQP00977Filter filter = new SQP00977Filter();

        try {
            logic = new download0425FormLogic();
    ...
    @RequestMapping(value = "ProcesarTKTATOS")
    public @ResponseBody
    String ProcesarTKTATOS(ModelMap map, HttpServletRequest request) {
        String result = "";
        SQP00977Filter filter = new SQP00977Filter();
        ...
        try {
            ...
            logic = new download0425FormLogic();
            logic.setSession(this.serverSession.getServerSession());
            result = logic.ProcesarTKTATOS(filter);
    ...
    void getXLSX(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            logic = new download0425FormLogic();
            logic.setSession(this.serverSession.getServerSession());
            List<SQP00977Filter> listaData = logic.Search(filter);

            // <editor-fold defaultstate="collapsed" desc="Estilo del Excel">
            //Workbook workbook = new XSSFWorkbook();
            int limite = 300;
            SXSSFWorkbook workbook = new SXSSFWorkbook(limite);
            Sheet sheet = workbook.createSheet("download0425Form");
...
//            headerStyle.setFillForegroundColor(IndexedColors.BLUE_GREY.getIndex());
            ...
            Cell CH_00, CH_01, CH_02, CH_03, CH_04, CH_05, CH_06, CH_07, CH_08, CH_09, CH_10, CH_11,
                    CH_12, CH_13, CH_14, CH_15, CH_16, CH_17, CH_18, CH_19, CH_20, CH_21, CH_22, CH_23, CH_24, CH_25, CH_26, CH_27, CH_28, CH_29, CH_30, CH_31, CH_32, CH_33, CH_34;
            ...
            CH_06.setCellValue("Itinerary");
            CH_07.setCellValue("Farebasis 1");
            CH_08.setCellValue("Farebasis 2");
            CH_09.setCellValue("Farebasis 3");
            CH_10.setCellValue("Farebasis 4");
            CH_11.setCellValue("Class 1");
            CH_12.setCellValue("Class 2");
            CH_13.setCellValue("Class 3");
            CH_14.setCellValue("Class 4");
            CH_15.setCellValue("Form of Payment");
            CH_16.setCellValue("Form of type");
            CH_17.setCellValue("Card Type");
            CH_18.setCellValue("Card number");
            CH_19.setCellValue("PAX");
            CH_20.setCellValue("PAX Type");
            CH_21.setCellValue("Sale Date");
            CH_22.setCellValue("Currency");
            CH_23.setCellValue("Rate");
            CH_24.setCellValue("Total Commision");
            CH_25.setCellValue("Total Tax");
            CH_26.setCellValue("Sale country");
            CH_27.setCellValue("FCMI");
            ...
            while (iter.hasNext()) {
                ...
                CH_00.setCellValue(listaData.get(vi).A2558TIKET);
                CH_01.setCellValue(listaData.get(vi).A2558FUENT);
                CH_02.setCellValue(listaData.get(vi).A2558SFUEN);
                CH_03.setCellValue(listaData.get(vi).A2558TRNCU);
                CH_04.setCellValue(listaData.get(vi).A2558AGTIA);
                CH_05.setCellValue(listaData.get(vi).A2558AGENT);
                CH_06.setCellValue(listaData.get(vi).ITINERARIO);
                CH_07.setCellValue(listaData.get(vi).A2558FBRI1);
                CH_08.setCellValue(listaData.get(vi).A2558FBRI2);
                CH_09.setCellValue(listaData.get(vi).A2558FBRI3);
                CH_10.setCellValue(listaData.get(vi).A2558FBRI4);
                CH_11.setCellValue(listaData.get(vi).A2558CLAS1);
                CH_12.setCellValue(listaData.get(vi).A2558CLAS2);
                CH_13.setCellValue(listaData.get(vi).A2558CLAS3);
                CH_14.setCellValue(listaData.get(vi).A2558CLAS4);
                CH_15.setCellValue(listaData.get(vi).A2558CFOP);
                CH_16.setCellValue(listaData.get(vi).A2558TFOP);
                CH_17.setCellValue(listaData.get(vi).A2558TTARJ);
                CH_18.setCellValue(listaData.get(vi).A2558NREF);
                CH_19.setCellValue(listaData.get(vi).A2558PAX);
                CH_20.setCellValue(listaData.get(vi).A2558TPAX);
                CH_21.setCellValue(listaData.get(vi).A2558FVTA);
                CH_22.setCellValue(listaData.get(vi).A2558MDA);
                CH_23.setCellValue(listaData.get(vi).A2558TRIFA);
                CH_24.setCellValue(listaData.get(vi).A2558TTCOM);
                CH_25.setCellValue(listaData.get(vi).A2558TTAX);
                CH_26.setCellValue(listaData.get(vi).A2558PVTA);
                CH_27.setCellValue(listaData.get(vi).A2558ARPI);
                CH_28.setCellValue(listaData.get(vi).A2558PNR);
                CH_29.setCellValue("");//listaData.get(vi).A2558ESTPD
                CH_30.setCellValue(listaData.get(vi).A2558TVTA);
                CH_31.setCellValue(listaData.get(vi).A2558CDIT);
                CH_32.setCellValue(listaData.get(vi).A2558CHEQ);
                CH_33.setCellValue(listaData.get(vi).A2558FLAG);
                CH_34.setCellValue(listaData.get(vi).A2558NLOTE);
            ...
            String fileNameDownload = String.format("download0425Form - " + Functions.getFechaActual() + ".xlsx", UUID.randomUUID().toString().toLowerCase());
