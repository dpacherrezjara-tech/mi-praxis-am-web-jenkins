...
//
    ...
    public List<A4116Filter> loadPX570SQP04456(A4116Filter filter) throws SQLException, Exception {
        ...
        String SQLCLL01 = "{CALL " + session.getMainLibrary() + ".SQP04456(?,?,?,?,?,?,?,?,?,?,?)}";
    ...
    public List<A4116Filter> loadPX570SQP04284(A4116Filter filter) throws SQLException, Exception {
        ...
        try {
            ...
            cstmt.setString(2, filter.IN_DATEFROM);
            cstmt.setString(3, filter.IN_DATETO);
            cstmt.setString(4, filter.DATE);
            cstmt.setString(5, filter.IN_DATE);
            cstmt.setString(6, filter.IN_MERCHID);
            cstmt.setString(7, filter.IN_PCURRENCY);
            cstmt.setString(8, filter.IN_STVAL);
            cstmt.setString(9, filter.IN_PNR);
            cstmt.setString(10, filter.IN_TDOC);
            cstmt.setInt(11, filter.page.PAGNUM);
            cstmt.setInt(12, filter.page.PAGROW);
            cstmt.setInt(13, filter.page.TOTPAG);
            cstmt.setInt(14, filter.page.TOTROW);
