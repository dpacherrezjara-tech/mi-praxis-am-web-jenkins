 ...
 * @author lmendoza
 */
public class InvoiceCommissionConsortiaContractDAO {
    ...
    public InvoiceCommissionConsortiaContractDAO() {
    }
    ...
    public InvoiceCommissionConsortiaContractDAO(IServerSession ss) {
        session = ss;
    }
