...
public class ReconciliationDoublePaymentDAO {
    ...
    public ReconciliationDoublePaymentDAO() {
    }
    ...
    public ReconciliationDoublePaymentDAO(IServerSession ss) {
        session = ss;
    }
    ...
    public List<A4116Filter> loadPX622SQP04955(A4116Filter filter) throws SQLException, Exception {
        ...
        hmDescFCOMPL.put("", "");
        hmDescFCOMPL.put("1", "PLUSGRADE"); //PLUSGRADE
        hmDescFCOMPL.put("2", "LIGAS"); //LIGAS
        hmDescFCOMPL.put("3", "TABLET"); //TABLET
        hmDescFCOMPL.put("4", "BPO"); //BPO
        ...
        try {
            ...
            cstmt.setString(11, filter.IN_PROCTYPE);
            cstmt.setString(12, filter.IN_MERCH_ERR);
