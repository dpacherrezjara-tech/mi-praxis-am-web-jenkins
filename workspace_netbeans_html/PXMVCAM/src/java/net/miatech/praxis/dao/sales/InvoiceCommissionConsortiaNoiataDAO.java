 ...
 * @author lmendoza
 */
public class InvoiceCommissionConsortiaNoiataDAO {
    ...
    public InvoiceCommissionConsortiaNoiataDAO() {
    }
    ...
    public InvoiceCommissionConsortiaNoiataDAO(IServerSession ss) {
        session = ss;
    }
