...
public class SalesComplementDAO implements SalesComplementLogic {
    ...
    public SQP04979Filter getSQP04979Filter(SQP04979Filter filter) throws Exception {
        ...
        SimpleJdbcCall jdbcCall = new SimpleJdbcCall(jdbcTemplate)
                ...
                .withProcedureName("SQP04979")
                .returningResultSet("result", new BeanPropertyRowMapper<>(A4453Filter.class));
        filter.setPage();
    ...
    public SQP04980Filter getSQP04980Filter(SQP04980Filter filter) throws Exception {
        ...
        SimpleJdbcCall jdbcCall = new SimpleJdbcCall(jdbcTemplate)
                .withSchemaName("PRAXISMP")
                .withProcedureName("SQP04980")
                .returningResultSet("result", new BeanPropertyRowMapper<>(A4454Filter.class));
        filter.setPage();
        SqlParameterSource params = new BeanPropertySqlParameterSource(filter);
        Map<String, Object> obj = jdbcCall.execute(params);
    ...
    public SQP04982Filter getSQP04982Filter(SQP04982Filter filter) throws Exception {
        ...
        SimpleJdbcCall jdbcCall = new SimpleJdbcCall(jdbcTemplate)
                .withSchemaName("PRAXISMP")
                .withProcedureName("SQP04982")
                .returningResultSet("result", new BeanPropertyRowMapper<>(A4455Filter.class));
        filter.setPage();
        SqlParameterSource params = new BeanPropertySqlParameterSource(filter);
        Map<String, Object> obj = jdbcCall.execute(params);
