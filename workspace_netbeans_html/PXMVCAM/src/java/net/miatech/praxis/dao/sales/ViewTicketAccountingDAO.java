            ...
            while (rs01.next()) {
                if (filter.FLAG.equals("1")) {
                    ...
                    if (filter.TRANSACTION.equals("RFTX")) {
                        ...
                        try {
                            App.CALL_CL3050(session.getCNXIBMDB2().getSystem(), session.getMainLibrary(), session.getUserView().getCustomerInfo().CCUST);
                            String programName = "/QSYS.LIB/" + session.getMainLibrary() + ".LIB/PRO11841.PGM";

                            //<editor-fold defaultstate="collapsed" desc="{...} Mapping">
                            AS400Map mapping = new AS400Map();

                            //<editor-fold defaultstate="collapsed" desc="{...} TRAMA-10206-IN    ">
                            class IDX_TRAMA_11803_IN {

                                static final int TRAMA_11803_IN = 0;
                            }
                            AS400DataType[] TRAMA_11803_IN = new AS400DataType[1];
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...} 01 REC-DATA-10206-IN    ">
                            class IDX_REC_DATA_11803_IN {

                                static final int DATOS_IN = 0;
                            }
                            AS400DataType[] REC_DATA_11803_IN = new AS400DataType[1];
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...}   03 DATOS-IN      ">
                            class IDX_DATOS_IN {

                                static final int REC_PROGRAMA_11803 = 0;
                                static final int REC_GRUPO_11803 = 1;
                                static final int REC_TRNC_11803 = 2;
                                static final int REC_CIA_11803 = 3;
                                static final int REC_FORMA_11803 = 4;
                                static final int REC_SERIE_11803 = 5;
                                static final int REC_SEQ_11803 = 6;
                                static final int REC_CUPON1_11803 = 7;
                                static final int REC_CUPON2_11803 = 8;
                                static final int REC_CUPON3_11803 = 9;
                                static final int REC_CUPON4_11803 = 10;
                            }
                            AS400DataType[] DATOS_IN = new AS400DataType[11];
                            DATOS_IN[IDX_DATOS_IN.REC_PROGRAMA_11803] = mapping.Char(10);
                            DATOS_IN[IDX_DATOS_IN.REC_GRUPO_11803] = mapping.Char(9);
                            DATOS_IN[IDX_DATOS_IN.REC_TRNC_11803] = mapping.Char(4);
                            DATOS_IN[IDX_DATOS_IN.REC_CIA_11803] = mapping.Char(3);
                            DATOS_IN[IDX_DATOS_IN.REC_FORMA_11803] = mapping.Char(4);
                            DATOS_IN[IDX_DATOS_IN.REC_SERIE_11803] = mapping.Char(6);
                            DATOS_IN[IDX_DATOS_IN.REC_SEQ_11803] = mapping.Char(2);
                            DATOS_IN[IDX_DATOS_IN.REC_CUPON1_11803] = mapping.Char(1);
                            DATOS_IN[IDX_DATOS_IN.REC_CUPON2_11803] = mapping.Char(1);
                            DATOS_IN[IDX_DATOS_IN.REC_CUPON3_11803] = mapping.Char(1);
                            DATOS_IN[IDX_DATOS_IN.REC_CUPON4_11803] = mapping.Char(1);

                            REC_DATA_11803_IN[IDX_REC_DATA_11803_IN.DATOS_IN] = mapping.Char(mapping.GetDimension(DATOS_IN));
                            TRAMA_11803_IN[IDX_TRAMA_11803_IN.TRAMA_11803_IN] = mapping.Char(mapping.GetDimension(REC_DATA_11803_IN));
                            //</editor-fold>

                            //<editor-fold defaultstate="collapsed" desc="{...} TRAMA-10206    ">
                            class IDX_TRAMA_11803 {

                                static final int TRAMA_11803 = 0;
                            }
                            AS400DataType[] TRAMA_11803 = new AS400DataType[1];
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...} 01 REC-DATA-10206    ">
                            class IDX_REC_DATA_11803 {

                                static final int DATOS_INPUT = 0;
                                static final int DATOS_OUTPUT = 1;
                            }
                            AS400DataType[] REC_DATA_11803 = new AS400DataType[2];
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...}   03 DATOS-INPUT      ">
                            class IDX_DATOS_INPUT {
                            ...
                            AS400DataType[] DATOS_INPUT = new AS400DataType[11];
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_PROGRAMA_11803] = mapping.Char(10);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_GRUPO_11803] = mapping.Char(9);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_TRNC_11803] = mapping.Char(4);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_CIA_11803] = mapping.Char(3);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_FORMA_11803] = mapping.Char(4);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_SERIE_11803] = mapping.Char(6);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_SEQ_11803] = mapping.Char(2);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_CUPON1_11803] = mapping.Char(1);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_CUPON2_11803] = mapping.Char(1);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_CUPON3_11803] = mapping.Char(1);
                            DATOS_INPUT[IDX_DATOS_INPUT.REC_CUPON4_11803] = mapping.Char(1);
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...}   03 DATOS-OUTPUT * ">
                            class IDX_DATOS_OUTPUT {

                                static final int REC_ESTADO_11803 = 0;
                                static final int REC_CODERR_11803 = 1;
                                static final int REC_MSJERR_11803 = 2;
                                static final int RD_GRUPO = 3;
                                static final int RD_FUENT = 4;
                                static final int RD_PSVTA = 5;
                                static final int RD_SFUEN = 6;
                            ...
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...}       04 REC-ESTADO-10206">
                            AS400DataType[] REC_ESTADO_11803 = new AS400DataType[1];
                            REC_ESTADO_11803[0] = mapping.Char(1);
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...}       04 REC-CODERR-10206">
                            AS400DataType[] REC_CODERR_11803 = new AS400DataType[1];
                            REC_CODERR_11803[0] = mapping.Char(6);
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...}       04 REC-MSJERR-10206">
                            AS400DataType[] REC_MSJERR_11803 = new AS400DataType[1];
                            REC_MSJERR_11803[0] = mapping.Char(80);
                            //</editor-fold>
                            //<editor-fold defaultstate="collapsed" desc="{...}       04 RD-GRUPO       ">
                            AS400DataType[] RD_GRUPO = new AS400DataType[1];
                            //</editor-fold>
                            ...
                            //<editor-fold defaultstate="collapsed" desc="{...}*DATOS_OUTPUT">
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_ESTADO_11803] = mapping.Char(mapping.GetDimension(REC_ESTADO_11803));
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_CODERR_11803] = mapping.Char(mapping.GetDimension(REC_CODERR_11803));
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_MSJERR_11803] = mapping.Char(mapping.GetDimension(REC_MSJERR_11803));
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.RD_GRUPO] = mapping.Char((mapping.GetDimension(WO_GRUPO) * mapping.getOccursSize(RD_GRUPO[0])));
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.RD_FUENT] = mapping.Char((mapping.GetDimension(WO_FUENT) * mapping.getOccursSize(RD_FUENT[0])));
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.RD_PSVTA] = mapping.Char((mapping.GetDimension(WO_PSVTA) * mapping.getOccursSize(RD_PSVTA[0])));
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.RD_SFUEN] = mapping.Char((mapping.GetDimension(WO_SFUEN) * mapping.getOccursSize(RD_SFUEN[0])));
                            ...
                            DATOS_OUTPUT[IDX_DATOS_OUTPUT.RD_TD_ORACAR] = mapping.Char((mapping.GetDimension(WO_TD_ORACAR) * mapping.getOccursSize(RD_TD_ORACAR[0])));
                            //</editor-fold>
                            REC_DATA_11803[IDX_REC_DATA_11803.DATOS_INPUT] = mapping.Char(mapping.GetDimension(DATOS_INPUT));
                            REC_DATA_11803[IDX_REC_DATA_11803.DATOS_OUTPUT] = mapping.Char(mapping.GetDimension(DATOS_OUTPUT));

                            int dim = mapping.GetDimension(REC_DATA_11803);

                            TRAMA_11803[IDX_TRAMA_11803.TRAMA_11803] = mapping.Char(dim);

                            //<editor-fold defaultstate="collapsed" desc="{...} Structures">
                            AS400Structure structure = new AS400Structure(TRAMA_11803);
                            AS400Structure structure00 = new AS400Structure(REC_DATA_11803);
                            AS400Structure structure01 = new AS400Structure(DATOS_INPUT);
                            AS400Structure structure02 = new AS400Structure(DATOS_OUTPUT);
                            AS400Structure structure03 = new AS400Structure(REC_ESTADO_11803);
                            AS400Structure structure04 = new AS400Structure(REC_CODERR_11803);
                            AS400Structure structure05 = new AS400Structure(REC_MSJERR_11803);
                            AS400Structure structure06 = new AS400Structure(RD_GRUPO);
                            AS400Structure structure07 = new AS400Structure(WO_GRUPO);
                            AS400Structure structure08 = new AS400Structure(RD_FUENT);
                            AS400Structure structure09 = new AS400Structure(WO_FUENT);
                            ...
                            ProgramParameter[] parameterList = new ProgramParameter[2];
                            parameterList[0] = new ProgramParameter(TRAMA_11803_IN[IDX_TRAMA_11803_IN.TRAMA_11803_IN].toBytes(rs01.getString("PRE_CONTA")));
                            parameterList[1] = new ProgramParameter(dim);
                            ...
                            if (program.run() != true) {
                                ...
                                byte[] receiverVar = parameterList[1].getOutputData();
                                //<editor-fold defaultstate="collapsed" desc="{...} Load Trama">
                                Object[] N_TRAMA_11803 = (Object[]) structure.toObject(receiverVar, 0);
                                Object[] N01_REC_DATA_11803 = (Object[]) structure00.toObject(TRAMA_11803[0].toBytes(N_TRAMA_11803[0]), 0);
                                Object[] N03_DATOS_INPUT = (Object[]) structure01.toObject(REC_DATA_11803[0].toBytes(N01_REC_DATA_11803[0]), 0);
                                Object[] N03_DATOS_OUTPUT = (Object[]) structure02.toObject(REC_DATA_11803[1].toBytes(N01_REC_DATA_11803[1]), 0);
                                Object[] N04_REC_ESTADO_11803 = (Object[]) structure03.toObject(REC_ESTADO_11803[0].toBytes(N03_DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_ESTADO_11803]), 0);
                                Object[] N04_REC_CODERR_11803 = (Object[]) structure04.toObject(REC_CODERR_11803[0].toBytes(N03_DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_CODERR_11803]), 0);
                                Object[] N04_REC_MSJERR_11803 = (Object[]) structure05.toObject(REC_MSJERR_11803[0].toBytes(N03_DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_MSJERR_11803]), 0);
                                ...
                                for (int i = 0; i < N04_RD_GRUPO.length; i++) {
                                    ...
                                    if (mapping.getString(N04_WO_GRUPO.get(i)[IDX_WO_GRUPO.RD_GRUPO]).trim().length() > 0) {
                                        objRtn = new PX0241S01A720Filter();
                                        //<editor-fold defaultstate="collapsed" desc="{...}">
                                        objRtn.TKT = mapping.getString(N03_DATOS_INPUT[IDX_DATOS_INPUT.REC_CIA_11803]) + mapping.getString(N03_DATOS_INPUT[IDX_DATOS_INPUT.REC_FORMA_11803]) + mapping.getString(N03_DATOS_INPUT[IDX_DATOS_INPUT.REC_SERIE_11803]);
                                        objRtn.SEQ = mapping.getString(N03_DATOS_INPUT[IDX_DATOS_INPUT.REC_SEQ_11803]);
                                        objRtn.STATUS = rs01.getString("STATUS");
                                        objRtn.ERROR = mapping.getString(N03_DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_ESTADO_11803]);
                                        objRtn.CODERROR = mapping.getString(N03_DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_CODERR_11803]);
                                        objRtn.MENSAJE = mapping.getString(N03_DATOS_OUTPUT[IDX_DATOS_OUTPUT.REC_MSJERR_11803]);
                                        objRtn.GRUPO = mapping.getString(N04_WO_GRUPO.get(i)[IDX_WO_GRUPO.RD_GRUPO]);
                                        objRtn.FUENTE = mapping.getString(N04_WO_FUENT.get(i)[IDX_WO_FUENT.RD_FUENT]);
                                        objRtn.PAIS = mapping.getString(N04_WO_PSVTA.get(i)[IDX_WO_PSVTA.RD_PSVTA]);
                                        objRtn.SUBFUENTE = mapping.getString(N04_WO_SFUEN.get(i)[IDX_WO_SFUEN.RD_SFUEN]);
