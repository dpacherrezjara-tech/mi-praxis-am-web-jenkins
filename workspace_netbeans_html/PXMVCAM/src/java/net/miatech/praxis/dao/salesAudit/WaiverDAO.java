...
public class WaiverDAO {
    ...
    public List<A2537Filter> lstsearch(A2537Filter filter) throws SQLException, Exception {
        ...
        try {
            ...
            cstmt01.setString(3, filter.VP_NCASO);
            cstmt01.setString(4, filter.VP_TKTS);
            cstmt01.setString(5, filter.VP_CODIT);
            cstmt01.setString(6, filter.VP_FCRRE1);
            cstmt01.setString(7, filter.VP_FCRRE2);
            cstmt01.setString(8, filter.VP_FVETO1);
            cstmt01.setString(9, filter.VP_FVETO2);
            ...
            while (rs01 != null && rs01.next()) {
                ...
                objRtn.A2537SEQ = rs01.getString("A2537SEQ");
                objRtn.A2537NCASO = rs01.getString("A2537NCASO");
                objRtn.A2537PCASO = rs01.getString("A2537PCASO");
                objRtn.A2537FCRRE = rs01.getString("A2537FCRRE");
                objRtn.A2537HCRRE = rs01.getString("A2537HCRRE");
                objRtn.A2537FVETO = rs01.getString("A2537FVETO");
                objRtn.A2537HVETO = rs01.getString("A2537HVETO");
                objRtn.A2537ESTAD = rs01.getString("A2537ESTAD");
                objRtn.A2537CODIT = rs01.getString("A2537CODIT");
                objRtn.A2537PNR = rs01.getString("A2537PNR");
                objRtn.A2537NVLO = rs01.getString("A2537NVLO");
                objRtn.A2537FVLO = rs01.getString("A2537FVLO");
                objRtn.A2537HVLO = rs01.getString("A2537HVLO");
                objRtn.A2537ITIN = rs01.getString("A2537ITIN");
                objRtn.A2537NPAX = rs01.getString("A2537NPAX");
                objRtn.A2537TKTS = rs01.getString("A2537TKTS");
                objRtn.A2537TCASO = rs01.getString("A2537TCASO");
                objRtn.A2537CCPTO = rs01.getString("A2537CCPTO");
                objRtn.A2537SCPTO = rs01.getString("A2537SCPTO");
                objRtn.A2537CURRW = rs01.getString("A2537CURRW");
                objRtn.A2537AMOUW = rs01.getString("A2537AMOUW");
                objRtn.A2537IATAE = rs01.getString("A2537IATAE");
                objRtn.A2537AGENE = rs01.getString("A2537AGENE");
                objRtn.A2537EJECB = rs01.getString("A2537EJECB");
                objRtn.A2537DESCR = rs01.getString("A2537DESCR");
                objRtn.A2537RUTAA = rs01.getString("A2537RUTAA");
                ...
                // objRtn.A2537TKTS_HAS_WAIVER = rs01.getString("A2537TKTS_HAS_WAIVER"); // habilitar cuando SP SQP01443 devuelva esta columna
    ...
    public List<Map<String, String>> lstTicketWaiver(String ccust, String tickets) throws SQLException, Exception {
        ...
        try {
            ...
            while (rs01 != null && rs01.next()) {
                ...
                row.put("A1672CCUST", rs01.getString("A1672CCUST"));
                row.put("TICKET",     rs01.getString("TICKET"));
                row.put("A1672CODWA", rs01.getString("A1672CODWA"));
                lstRtn.add(row);
            }
        } finally {
            if (rs01 != null) {
                try { rs01.close(); } catch (SQLException e) {
                    logError.error("SQLException -> User:" + session.getUserView().getUserInfo().USR + " Message: " + e.getMessage(), e);
                }
            }
            if (cstmt01 != null) {
                try { cstmt01.close(); } catch (SQLException e) {
                    logError.error("SQLException -> User:" + session.getUserView().getUserInfo().USR + " Message: " + e.getMessage(), e);
                }
            }
            session.getCNXIBMDB2().closeIBMDB2Connection(cnx);
