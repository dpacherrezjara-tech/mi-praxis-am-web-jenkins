...
public class ReportEdoCtaPre {
    ...
    public void setHeader10(int PosX1, int PYi, PdfWriter writer ){
        ...
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("ANTICIPO", subFontT)), PosX1, PYi, 0);        
        ...
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Moneda", subFont_1)), 280, PYi, 0); //300
    ...
    public void setHeader20(int PosX1, int PYi, PdfWriter writer ){
        ...
        PdfContentByte canvas = writer.getDirectContent();
        PdfContentByte under = writer.getDirectContentUnder();
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("BENEFICIO", subFontT)), PosX1, PYi, 0);        
        PYi = PYi - 14; //salto entre linea
        colorRectangle(under, new CMYKColor(1f, 0f, 0f, 0.5f), 15, PYi-5, 590, 15); //700
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Fecha", subFont_1)), PosX1, PYi, 0);            
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("ID Recibo", subFont_1)), 60, PYi, 0);
    ...
    public void setHeader30(int PosX1, int PYi, PdfWriter writer ){
        ...
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Moneda", subFont_1)), 280, PYi, 0);
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Cant. Trx.", subFont_1)), 400, PYi, 0);
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Importe", subFont_1)), 560, PYi, 0);
    }    
    ...
    public void setHeader40(int PosX1, int PYi, PdfWriter writer ){
        ...
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Nº Reporte", subFont_1)), 60, PYi, 0);
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Periodo", subFont_1)), 150, PYi, 0);
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Moneda", subFont_1)), 230, PYi, 0);
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Cant. Trx.", subFont_1)), 400, PYi, 0);
        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("Importe", subFont_1)), 560, PYi, 0);
    }
    ...
    public File createReport(List<SQP04560Filter> Data, String Rutatmp ) {
...
//            
            Py_c = Py_c - Hlng;
//            String VL_PERIODO = "";
//            if(!Data.get(0).rpteCab.A4258INIPR.equals("")){
//                VL_PERIODO = Data.get(0).rpteCab.A4258INIPR + " Al " + Data.get(0).rpteCab.A4258FINPR; 
//            }            
            Phrase txtPERIODO = new Phrase(new Paragraph("Al cierre: " + Data.get(0).rpteCab.A4258FINPR  , NORMAL));
            ...
            // '10' = anticipo
            // '20' = beneficio
            // '30' = REPORTE VTAS  - SALE/EXCH  
            // '40' = REPORTE VTAS  - RFND     
...
//            Integer cont60_TTL = 0;            
            for (int i = 3; i < Data.size(); i++) {
                if( Data.get(i).rpteDet.A4259TREG.equals("10")) cont10_TTL++;
                if( Data.get(i).rpteDet.A4259TREG.equals("20")) cont20_TTL++;
                if( Data.get(i).rpteDet.A4259TREG.equals("30")) cont30_TTL++;
                if( Data.get(i).rpteDet.A4259TREG.equals("40")) cont40_TTL++;
//                if( Data.get(i).rpteDet.A4259TREG.equals("50")) cont50_TTL++;
//                if( Data.get(i).rpteDet.A4259TREG.equals("60")) cont60_TTL++;
            }
...
//            Integer cont60 = 0;
            ...
            Double Subtotal_ANTICIPO = 0.0;
            Double Subtotal_BENEFICIO = 0.0;
...
//            Double subTotal_pago_AP_REC = 0.0;
            ...
            for (int i = 3; i < Data.size(); i++) {
                ...
                if( Data.get(i).rpteDet.A4259TREG.equals("00")){                    
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph( formato_numero(Data.get(i).rpteDet.A4259TOT) , NORMAL)), 595, PYi, 0); //700                    
                }                
                //+++++++++++++++++++++++++++++++++
                //++ ANTICIPOS
                //+++++++++++++++++++++++++++++++++
                if( Data.get(i).rpteDet.A4259TREG.equals("10")){
                    cont10 ++;
                    if( cont10 == 1 ){
                        PYi = PYi - 25;
                    ...
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259FECPR, subFont)), 15, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259IDPRO, subFont)), 60, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259REFBC, subFont)), 150, PYi, 0);                
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259MDLOC, subFont)), 280, PYi, 0);  //300                              
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numeroInt(Data.get(i).rpteDet.A4259QTYTX), subFont)), 420, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numero(Data.get(i).rpteDet.A4259TOT), subFont)), 595, PYi, 0); //700               
                    Subtotal_ANTICIPO = Subtotal_ANTICIPO + Data.get(i).rpteDet.A4259TOT;
                    PYi = PYi - 12;
                    //Sub Total cuando termine el registro 10 - ventas
                    if ( cont10_TTL.equals(cont10)){
                        PYi = PYi - 10;                        
                        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("SUBTOTAL: ", subFontT)), pos_sub_ttl, PYi, 0);                        
                        ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph( formato_numero(Subtotal_ANTICIPO), subFontT)), pos_sub_ttl_a, PYi, 0);
                    }
                }
                //+++++++++++++++++++++++++++++++++
                //++ BENEFICIOS
                //+++++++++++++++++++++++++++++++++
                if( Data.get(i).rpteDet.A4259TREG.equals("20")){
                    cont20 ++;
                    if( cont20 == 1 ){
                        PYi = PYi - 25;
                    ...
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numeroInt(Data.get(i).rpteDet.A4259QTYTX), subFont)), 420, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numero(Data.get(i).rpteDet.A4259TOT), subFont)), 595, PYi, 0); //700               
                    Subtotal_BENEFICIO = Subtotal_BENEFICIO + Data.get(i).rpteDet.A4259TOT;
                    PYi = PYi - 12;
                    //Sub Total cuando termine el registro 10 - ventas
                    if ( cont20_TTL.equals(cont20)){
                        PYi = PYi - 10;                        
                        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("SUBTOTAL: ", subFontT)), pos_sub_ttl, PYi, 0);                        
                        ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph( formato_numero(Subtotal_BENEFICIO), subFontT)), pos_sub_ttl_a, PYi, 0);
                    }
                }
                //+++++++++++++++++++++++++++++++++
                //++ VENTAS 
                //+++++++++++++++++++++++++++++++++
                if( Data.get(i).rpteDet.A4259TREG.equals("30")){
                    cont30 ++;
                    if( cont30 == 1 ){
                        PYi = PYi - 25;
                    ...
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259FECPR, subFont)), 15, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259IDPRO, subFont)), 60, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259INIPR.trim() +'-'+ Data.get(i).rpteDet.A4259FINPR.trim(), subFont)), 150, PYi, 0);                
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259MDLOC, subFont)), 280, PYi, 0);  //300                              
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numeroInt(Data.get(i).rpteDet.A4259QTYTX), subFont)), 420, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numero(Data.get(i).rpteDet.A4259TOT), subFont)), 595, PYi, 0); //700               
                    Subtotal_VENTA = Subtotal_VENTA + Data.get(i).rpteDet.A4259TOT;
                    PYi = PYi - 12;
                    //Sub Total cuando termine el registro 10 - ventas
                    if ( cont30_TTL.equals(cont30)){
                        PYi = PYi - 10;                        
                        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("SUBTOTAL: ", subFontT)), pos_sub_ttl, PYi, 0);                        
                        ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph( formato_numero(Subtotal_VENTA), subFontT)), pos_sub_ttl_a, PYi, 0);
                    }
                }
                //+++++++++++++++++++++++++++++++++
                //REEMBOLSOS
                //+++++++++++++++++++++++++++++++++
                if( Data.get(i).rpteDet.A4259TREG.equals("40")){
                    cont40 ++;
                    if( cont40 == 1 ){
                        PYi = PYi - 25;
                    ...
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259IDPRO, subFont)), 60, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259INIPR.trim() +'-'+ Data.get(i).rpteDet.A4259FINPR.trim(), subFont)), 150, PYi, 0);                
                    ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(i).rpteDet.A4259MDLOC, subFont)), 280, PYi, 0);                                
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numeroInt(Data.get(i).rpteDet.A4259QTYTX), subFont)), 420, PYi, 0);
                    ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase(new Paragraph(formato_numero(Data.get(i).rpteDet.A4259TOT), subFont)), 595, PYi, 0);                
                    Subtotal_REFUND= Subtotal_REFUND + Data.get(i).rpteDet.A4259TOT;
                    PYi = PYi - 12;
                    //Sub Total cuando termine el registro 10 - ventas
                    if ( cont40_TTL.equals(cont40)){
                        PYi = PYi - 10;                        
                        ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph("SUBTOTAL: ", subFontT)), pos_sub_ttl, PYi, 0);                        
...
//            ColumnText.showTextAligned(canvas, Element.ALIGN_LEFT, new Phrase(new Paragraph(Data.get(2).tbl_misl.A3961DESC2, subFont_2)), 17, PYi, 0); 
            ...
            PYi = PYi-15;
            ColumnText.showTextAligned(canvas, Element.ALIGN_RIGHT, new Phrase( new Paragraph(Data.get(0).rpteCab.A4258TOTLT, NORMAL)), 590, PYi, 0); //540
            //PYi = PYi-15;
