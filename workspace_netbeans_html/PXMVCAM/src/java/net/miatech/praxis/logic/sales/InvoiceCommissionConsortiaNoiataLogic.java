...
import net.miatech.praxis.dao.sales.InvoiceCommissionConsortiaNoiataDAO;
 ...
 * @author lmendoza
 */
public class InvoiceCommissionConsortiaNoiataLogic {

    private final InvoiceCommissionConsortiaNoiataDAO InvoiceCommissionConsortiaNoiataDAO = new InvoiceCommissionConsortiaNoiataDAO();

    public void setSession(IServerSession ss) {
        InvoiceCommissionConsortiaNoiataDAO.setSession(ss);

    }

    public List<SQP00801Filter> loadPX112S01A1757(SQP00801Filter filter) throws SQLException, Exception {
        return InvoiceCommissionConsortiaNoiataDAO.loadPX112S01A1757(filter);
    }

    public String get_PX112S03A1757(String VP_OPTION, String VP_PARAM) throws SQLException, Exception {
        return InvoiceCommissionConsortiaNoiataDAO.get_PX112S03A1757(VP_OPTION, VP_PARAM);
    }

    public SQP00802Filter setPX112S02A1757(SQP00802Filter filter) throws SQLException, Exception {
        return InvoiceCommissionConsortiaNoiataDAO.setPX112S02A1757(filter);
    }
    //    NEW. VH
      public List<SQP00804Filter> loadPX112S01A1728(SQP00804Filter filter) throws SQLException, Exception {
        return InvoiceCommissionConsortiaNoiataDAO.loadPX112S01A1728(filter);
    }
    
    public String subirExcel(ArrayList<SQP00802Filter> filter, String nameFile) throws SQLException, Exception {
        return InvoiceCommissionConsortiaNoiataDAO.subirExcel(filter, nameFile);
    }
    
    public List<SQP04749Filter> getSQP04749Filter(SQP04749Filter filter) throws Exception{
        return InvoiceCommissionConsortiaNoiataDAO.getSQP04749Filter(filter);
    }
}
