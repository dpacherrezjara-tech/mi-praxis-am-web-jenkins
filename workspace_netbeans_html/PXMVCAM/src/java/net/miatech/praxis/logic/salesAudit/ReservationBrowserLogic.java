...
public interface ReservationBrowserLogic {
    ...
    SQP05401Filter loadSQP05401Filter(SQP05401Filter filter) throws Exception;
    SQP05402Filter loadSQP05402Filter(SQP05402Filter filter) throws Exception;
    RobotSabreResponse loadExecuteRobot(RobotSabrePayload payload) throws Exception;
}
