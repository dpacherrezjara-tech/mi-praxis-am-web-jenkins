...
import net.miatech.praxis.dao.flown.FlightManifestDAO;
 ...
 * @author gsanchez
 */
public class FlightManifestLogic {

    private FlightManifestDAO objDAO = new FlightManifestDAO();

    public FlightManifestLogic() {
    }

    public FlightManifestLogic(IServerSession ss) {
