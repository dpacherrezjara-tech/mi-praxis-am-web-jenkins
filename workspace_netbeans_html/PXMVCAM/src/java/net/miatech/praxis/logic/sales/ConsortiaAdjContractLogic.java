...
import net.miatech.praxis.dao.sales.ConsortiaAdjContractDAO;
 ...
 * @author gsanchez
 */
public class ConsortiaAdjContractLogic {

    private ConsortiaAdjContractDAO objDAO = new ConsortiaAdjContractDAO();
