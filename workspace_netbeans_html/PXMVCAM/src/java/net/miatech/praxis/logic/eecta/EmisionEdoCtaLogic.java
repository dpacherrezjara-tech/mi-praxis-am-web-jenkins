...
public class EmisionEdoCtaLogic {
    ...
    public List<SQP04001Filter> getSQP04001Filter(SQP04001Filter filter) throws SQLException, Exception {
        return objDAO.getSQP04001Filter(filter);
    }
