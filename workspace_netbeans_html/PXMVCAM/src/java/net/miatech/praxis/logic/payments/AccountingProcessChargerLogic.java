...
import net.miatech.praxis.dao.payments.AccountingProcessChargerDAO;
 ...
 * @author gsanchez
 */
public class AccountingProcessChargerLogic {

    private AccountingProcessChargerDAO objDAO = new AccountingProcessChargerDAO();
