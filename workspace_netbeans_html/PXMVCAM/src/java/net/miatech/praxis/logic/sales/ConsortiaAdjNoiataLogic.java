...
import net.miatech.praxis.dao.sales.ConsortiaAdjNoiataDAO;
 ...
 * @author gsanchez
 */
public class ConsortiaAdjNoiataLogic {

    private ConsortiaAdjNoiataDAO objDAO = new ConsortiaAdjNoiataDAO();
