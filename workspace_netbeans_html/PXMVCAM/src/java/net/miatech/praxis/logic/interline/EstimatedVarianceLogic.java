...
import net.miatech.praxis.dao.interline.EstimatedVarianceDAO;
 ...
 * @author gsanchez
 */
public class EstimatedVarianceLogic {

    private EstimatedVarianceDAO objDAO = new EstimatedVarianceDAO();
