 ...
 * Project    : PRAXIS - AM                                       *          
 * Document   : GridData                                          *                          
 * Created on : 27/02/2018, 19:20:55                              *               
...
Ext.define('Ext.Praxis.model.flown.AccountingMasterFlown.GridData', {
    ...
    fields: [
        ...
        {name: 'A1740REGIS', type: 'string'},
        {name: 'A1740FREGI', type: 'string'},
        {name: 'A1740HREGI', type: 'string'}
    ]
});