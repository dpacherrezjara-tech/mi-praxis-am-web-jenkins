 ...
 *         &lt;element name="RuleLineDescription" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "AgencyFeesType", namespace = "http://services.sabre.com/res/or/v1_4", propOrder = {
    "passengerType",
    "numberOfPassengers",
    "date",
    "feeDescription",
...
public class AgencyFeesType {
    ...
    @XmlElement(name = "RuleLineDescription")
    protected String ruleLineDescription;
    @XmlElement(name = "RuleDetails")
