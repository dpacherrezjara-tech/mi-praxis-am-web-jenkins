Ext.define('Ext.Praxis.view.panel.ProfilesPermitsManagementForm.DataEntryReverse',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReverseProfilesPermitsManagementForm',

    controller: 'DataEntryReverseProfilesPermitsManagementController',

    requires:[
        'Ext.Praxis.controller.panel.ProfilesPermitsManagement.DataEntryReverseProfilesPermitsManagementController'
    ],
