Ext.define('Ext.Praxis.view.panel.ProfilesManagementForm.DataEntryReverse',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReverseProfilesManagementForm',

    controller: 'DataEntryReverseProfilesManagementController',

    requires:[
        'Ext.Praxis.controller.panel.ProfilesManagement.DataEntryReverseProfilesManagementController'
    ],
