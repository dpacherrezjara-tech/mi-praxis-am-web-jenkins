Ext.define('Ext.Praxis.view.interline.EstimatedVarianceForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryEstimatedVarianceForm',

    controller: 'DataEntryEstimatedVarianceController',

    requires:[
        'Ext.Praxis.controller.interline.EstimatedVariance.DataEntryEstimatedVarianceController'
    ],
