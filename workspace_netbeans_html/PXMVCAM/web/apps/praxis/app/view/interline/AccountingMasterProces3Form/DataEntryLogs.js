...
Ext.define('Ext.Praxis.view.interline.AccountingMasterProces3Form.DataEntryLogs', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryLogs',
    requires: [
        'Ext.Praxis.controller.interline.AccountingMasterProces3.DataEntryLogsAMPController'
    ],
