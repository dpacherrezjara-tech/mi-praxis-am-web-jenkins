Ext.define('Ext.Praxis.view.flown.FlightManifestForm.DataEntryExport', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryExportFlightManifestForm',
    requires: [
        'Ext.Praxis.controller.flown.FlightManifest.DataEntryExportFlightManifestController'
    ],
    controller: 'DataEntryExportFlightManifestController',
