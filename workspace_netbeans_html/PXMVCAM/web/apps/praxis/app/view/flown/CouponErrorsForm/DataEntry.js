Ext.define('Ext.Praxis.view.flown.CouponErrorsForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryCouponErrorsForm',
    requires: [
        'Ext.Praxis.controller.flown.CouponErrors.DataEntryCouponErrorsController'
    ],
    controller: 'DataEntryCouponErrorsController',
