Ext.define('Ext.Praxis.view.flown.BaseOdForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryBaseOdForm',

    controller: 'DataEntryBaseOdController',

    requires:[
        'Ext.Praxis.controller.flown.BaseOd.DataEntryBaseOdController'
    ],
