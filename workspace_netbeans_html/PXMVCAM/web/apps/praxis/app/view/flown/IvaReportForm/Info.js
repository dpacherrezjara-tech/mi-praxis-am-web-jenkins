                    ...
                    columns: {
                        ...
                        items: [
                            ...
                            {text: 'AUDIT',
                                ...
                                columns: [
                                    {text: 'Ticket_Number', width: 150, dataIndex: 'TICKET'},
                                    {text: 'Coupon_Number', width: 150, dataIndex: 'CUPON'},
                                    {text: 'SEQ', width: 75, dataIndex: 'SEQ'},
                                    {text: 'Flown_Flight_Date', width: 170, dataIndex: 'DFLIGHT'},
                                    {text: 'Flown_Flight_Period', width: 200, dataIndex: 'PFLIGHT'},
                                    {text: 'Flown_Flight_Number', width: 200, dataIndex: 'NFLIGHT'},
                                    {text: 'Carrier', width: 100, dataIndex: 'CARR'},
                                    {text: 'Stock', width: 100, dataIndex: 'STOCK'},
                                    {text: 'ORIGEN_LEG', width: 100, dataIndex: 'ORI'},
                                    {text: 'DESTINO_LEG', width: 100, dataIndex: 'DES'},
                                    {text: 'Amount_Revenue', width: 150, dataIndex: 'AMOUREV'},
                                    {text: 'TCAMBIO_REV_A_MXN', width: 170, dataIndex: 'TCREV'},
                                    {text: 'AMOUNT_LOC_A_MXN', width: 170, dataIndex: 'AMOULOC'},
                                    {text: 'Cuenta_Contable_cat', width: 320, dataIndex: 'CTACONT'},
                                    ...
                                    {text: 'TITULO_CONTABLE', width: 220, dataIndex: 'TITULO'},
                                ]
                            },
                            ...
                            {text: 'SEGUN CALCULO VTA',
                                ...
                                columns: [
                                    ...
                                    {text: 'Ruta_Fare Calc', width: 150, dataIndex: 'RUTFCALVT'},
                            ...
                            {text: 'SEGUN OD FARE CALC',
                                ...
                                columns: [
                                    ...
                                    {text: 'Ruta_Fare Calc', width: 150, dataIndex: 'RUTFCALOD'},
