Ext.define('Ext.Praxis.view.flown.FlightManifestForm.Info', {
                                                ...
                                                columns: [
                                                    {
                                                        ...
                                                        columns: [
                                                            {
                                                                text: 'Date', dataIndex: 'strFormatDate3', width: 80
                                                            }
                                                        ]
                                                    },
                                                    {
                                                        ...
                                                        columns: [
                                                            {
                                                                text: 'Date', dataIndex: 'strFormatDate', width: 80 //flex: 1
                                                            },
                                                            {
                                                                ...
                                                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                                    ...
                                                                    value = '<b>' + value + '</b>';
                                                                    return '<a href="#flown-flight-manifest-form" style="color:#008FE3;text-decoration:none;">' + value + '</a>';
                                                                }
                                                            }
                                                        ]
                                                    },
...
//                                                    text: '1',
                                                ...
                                                },
                                                {
                                                    ...
                                                    renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                                        ...
                                                        value = '<b>' + value + '</b>';
                                                        return '<a href="#flown-flight-manifest-form" style="color:#057ECB;text-decoration:none;">' + value + '</a>';
                                                    }
                                                }
                                            ]
                                        }
