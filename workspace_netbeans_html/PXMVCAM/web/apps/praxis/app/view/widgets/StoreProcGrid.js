...
Ext.define('Ext.Praxis.view.widgets.StoreProcGrid', {
    ...
    /**
     * @cfg {Boolean} actionsFirst
     * Si true, la columna de rowActions se ubica como primera columna del grid
     * en lugar de al final (default: false).
     */
    actionsFirst: false,
    ...
    _buildColumns: function () {
        ...
        if (me.rowActions && me.rowActions.length > 0) {
            ...
            if (me.actionsFirst) {
                // Si la primera columna es un rownumberer, las Actions van justo después.
                var insertAt = (columns[0] && columns[0].xtype === 'rownumberer') ? 1 : 0;
                columns.splice(insertAt, 0, actionColumn);
            } else {
