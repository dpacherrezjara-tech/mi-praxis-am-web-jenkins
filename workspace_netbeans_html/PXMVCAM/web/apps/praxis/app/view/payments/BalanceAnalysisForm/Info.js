                                        ...
                                        items: [
                                            ...
                                            {text: 'Sales',
                                                ...
                                                columns: [
                                                    ...
                                                    {text: 'CASH', dataIndex: 'NAMEBANK', align: 'Center',
                                                        defaults: {
                                                        menuDisabled: true,
                                                        sortable: true,
                                                        align: 'center',
                                                    ...
                                                    {text: 'CREDIT CARD', dataIndex: 'NAMEBANK', align: 'Center',
                                                        ...
                                                        columns: [
                                                            {text: 'Quantity',
                                                                ...
                                                                columns: [
                                                                     {text: 'Tickets', dataIndex: ' ', width: 80}    
                                                                  ]
                                                            },
                                                            {text: 'Amount', dataIndex: ' ', width: 100 },
                                                    ...
                                                    {text: '%Total', align: 'Center',
                                                        ...
                                                        columns: [
                                                            {text: 'by Amount', dataIndex: ' ', width: 90}
                                                        ]   
                                                    }
                                                ]
                                            },
                                            ...
                                            {text: 'Payments',
                                                ...
                                                columns: [
                                                    {text: 'Quantity',
                                                        ...
                                                        columns: [
                                                             {text: 'Tickets', dataIndex: 'IN_QTYSVFOP', width: 80}    
                                                          ]
                                                    },
                                                    {text: 'Amount', dataIndex: 'IN_SVFOP', width: 100 },
