Ext.define('Ext.Praxis.view.payments.ReconciliationPaymentTicketForm.DataEntryTicket', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryTicketReconciliationPaymentTicketForm',
    requires: [
        'Ext.Praxis.controller.payments.ReconciliationPaymentTicket.DataEntryTicketReconciliationPaymentTicketController'
    ],
    controller: 'DataEntryTicketReconciliationPaymentTicketController',
