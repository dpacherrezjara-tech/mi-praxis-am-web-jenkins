Ext.define('Ext.Praxis.view.payments.SalesAdjustmentForm.DataEntryPnr',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntrySalesAdjustmentForm',
    requires:[
        'Ext.Praxis.controller.payments.SalesAdjustment.DataEntryPnrSalesAdjustmentController'
    ],
    controller: 'DataEntryPnrSalesAdjustmentController',
