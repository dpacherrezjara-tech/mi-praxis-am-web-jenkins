 ...
 * -------------------------------
 */
Ext.define('Ext.Praxis.view.payments.MaintenanceAnalystsForm.DataEntryMaintenanceAnalysts', {
    ...
    requires: [
        'Ext.Praxis.controller.payments.MaintenanceAnalysts.DataEntryMaintenanceAnalystsController'
    ],
