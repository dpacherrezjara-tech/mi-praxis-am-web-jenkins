prototype.idEmds = prototype.id + '-DetailEmdsDataEntry';

Ext.define('Ext.Praxis.view.payments.EmdsControlForm.DataEntrys.DetailEmdsDataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DetailEmdsDataEntry',
    requires: [
        'Ext.Praxis.controller.payments.EmdsControl.DetailEmdsDataEntryController'
    ],
    title: 'Detail EMDs',
    header: true,
    width: 1200,
    ...
    layout: 'fit',
    modal: true,
    controller: 'DetailEmdsDataEntryController',
            ...
            items: [
                {
                    ...
                    items: [
                        {
                            xtype: 'grid',
                            id: prototype.idEmds + '-grid-Detail',
                            style: 'background: white',
//                            maxHeight: 550,
                            flex: 1,
                            columnLines: true,
