Ext.define('Ext.Praxis.view.payments.ReconciliationDoublePaymentForm.DataEntryPnr',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReconciliationDoublePaymentForm',
    requires:[
        'Ext.Praxis.controller.payments.ReconciliationDoublePayment.DataEntryPnrReconciliationDoublePaymentController'
    ],
    controller: 'DataEntryPnrReconciliationDoublePaymentController',
