Ext.define('Ext.Praxis.view.payments.ReconciliationPaymentTicketForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReconciliationPaymentTicketForm',
    requires: [
        'Ext.Praxis.controller.payments.ReconciliationPaymentTicket.DataEntryReconciliationPaymentTicketController'
    ],
    controller: 'DataEntryReconciliationPaymentTicketController',
