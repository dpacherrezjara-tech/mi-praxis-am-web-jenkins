Ext.define('Ext.Praxis.view.payments.SalesReconciliationControlForm.Grids.SummaryGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.' + prototype.id + '-SummaryGrid',
    requires: [
        'Ext.Praxis.controller.payments.SalesReconciliationControl.SummaryGridController'
    ],
