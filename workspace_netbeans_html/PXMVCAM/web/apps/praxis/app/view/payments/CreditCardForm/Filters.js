    ...
    items: [
        {
            ...
            items: [
                ...
                },
                {
                    ...
                    hidden: false,
                    items: [
                        { boxLabel: '<b style="color:#148D28;">Credit Card</b>', inputValue: 'CARD', name: 'rbgType', checked: false, width: 100, },
                        {xtype: 'tbspacer', width: 20},
                        { boxLabel: '<b style="color:#148D28;">Commissions</b>', inputValue: 'COMM', name: 'rbgType', checked: true }
                    ],
                    listeners: {
