Ext.define('Ext.Praxis.view.payments.SalesReconciliationDifferencesForm.Grids.SummaryGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.' + prototype.id + '-SummaryGrid',
    requires: [
        'Ext.Praxis.controller.payments.SalesReconciliationDifferences.SummaryGridController'
    ],
