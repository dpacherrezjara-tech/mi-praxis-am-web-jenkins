Ext.define('Ext.Praxis.view.payments.AccountingProcessChargerForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryAccountingProcessChargerForm',

    controller: 'DataEntryAccountingProcessChargerController',

    requires:[
        'Ext.Praxis.controller.payments.AccountingProcessCharger.DataEntryAccountingProcessChargerController'
    ],
                    ...
                    items:[
                        ...
                        { xtype: 'tbspacer', width: 10 },
                        {
                            ...
                            store: new Ext.data.SimpleStore({
                                ...
                                data: [
                                    ["", "(Select)"],
                                    ["PCHARGER", "CHARGER Accounting"],
                                    ["PSETTLE", "SETTLEMENT Accounting"]
                                ]
                            }),
                            queryMode: 'local',
                            hiddenLabel: false,
