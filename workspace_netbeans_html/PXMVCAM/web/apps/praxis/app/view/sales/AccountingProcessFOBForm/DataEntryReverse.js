Ext.define('Ext.Praxis.view.sales.AccountingProcessFOBForm.DataEntryReverse',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReverseAccountingProcessFOBForm',

    controller: 'DataEntryReverseAccountingProcessFobController',

    requires:[
        'Ext.Praxis.controller.sales.AccountingProcessFob.DataEntryReverseAccountingProcessFobController'
    ],
