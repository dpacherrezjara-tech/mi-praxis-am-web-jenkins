...
Ext.define('Ext.Praxis.view.sales.PercentCommissionContractForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.PercentCommissionContract.DataEntryPercentCommissionContractController'
    ],
    title: 'Percent Commission Contract',
    header: true,
    width: 800,
    height: 600,
    border: false,
