Ext.define('Ext.Praxis.view.sales.AccountingProcessConsortiaContractForm.DataEntryReverse',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReverseAccountingProcessConsortiaContractForm',

    controller: 'DataEntryReverseAccountingProcessConsortiaContractController',

    requires:[
        'Ext.Praxis.controller.sales.AccountingProcessConsortiaContract.DataEntryReverseAccountingProcessConsortiaContractController'
    ],
