Ext.define('Ext.Praxis.view.sales.InvoiceCommissionConsortiaNoiataForm.LoadFile',{
    extend: 'Ext.window.Window',
    alias: 'widget.LoadFileInvoiceCommissionConsortiaNoiataForm',
    requires:[
        'Ext.Praxis.controller.sales.InvoiceCommissionConsortiaNoiata.LoadFileController'
    ],
    controller: 'LoadFileController',
    title:'Load File Invoice Commission Consortia No IATA',
