Ext.define('Ext.Praxis.view.sales.InvoiceCommissionConsortiaContractForm.LoadFile',{
    extend: 'Ext.window.Window',
    alias: 'widget.LoadFileInvoiceCommissionConsortiaContractForm',
    requires:[
        'Ext.Praxis.controller.sales.InvoiceCommissionConsortiaContract.LoadFileController'
    ],
    controller: 'LoadFileController',
    title:'Load File Invoice Commission Consortia Contract',
