...
Ext.define('Ext.Praxis.view.sales.ConsortiaNoiataForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.ConsortiaNoiata.DataEntryConsortiaNoiataController'
    ],
    title: 'Consortia No IATA Information',
    header: true,
    width: 1150,
    height: 780,
    border: false,
