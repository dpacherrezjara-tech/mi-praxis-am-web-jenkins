...
Ext.define('Ext.Praxis.view.sales.InvoiceCommissionConsortiaContractForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.InvoiceCommissionConsortiaContract.DataEntryInvoiceCommissionConsortiaContractController'
    ],
    title: 'Invoice Commission Consortia Contract',
    header: true,
    width: 600,
    height: 650,
    border: false,
