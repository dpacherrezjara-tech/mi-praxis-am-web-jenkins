...
Ext.define('Ext.Praxis.view.sales.PercentCommissionNoiataForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.PercentCommissionNoiata.DataEntryPercentCommissionNoiataController'
    ],
    title: 'Percent Commission No IATA',
    header: true,
    width: 800,
    height: 600,
    border: false,
