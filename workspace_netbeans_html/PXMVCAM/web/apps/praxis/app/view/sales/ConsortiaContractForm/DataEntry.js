...
Ext.define('Ext.Praxis.view.sales.ConsortiaContractForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.ConsortiaContract.DataEntryConsortiaContractController'
    ],
    title: 'Consortia Contract Information',
    header: true,
    width: 1150,
    height: 780,
    border: false,
