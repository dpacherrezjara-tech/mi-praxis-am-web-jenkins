...
Ext.define('Ext.Praxis.view.sales.ConsortiaContractForm.Info', {
                        ...
                        items: [
                            {text: 'IATA', width: 70, dataIndex: 'A2444IATA',
                                ...
                                renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                                    ...
                                    value = '<b>' + value + '</b>';
                                    return '<a href="#sales-consortia-contract-form" style="color:#057ECB;text-decoration:none;">' + value + '</a>';
                                }
                            },
