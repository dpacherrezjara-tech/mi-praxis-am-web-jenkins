Ext.define('Ext.Praxis.view.sales.AccountingProcessFOBForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryAccountingProcessFOBForm',

    controller: 'DataEntryAccountingProcessFobController',

    requires:[
        'Ext.Praxis.controller.sales.AccountingProcessFob.DataEntryAccountingProcessFobController'
    ],
