Ext.define('Ext.Praxis.view.sales.AccountingProcessConsortiaNoiataForm.DataEntryReverse',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryReverseAccountingProcessConsortiaNoiataForm',

    controller: 'DataEntryReverseAccountingProcessConsortiaNoiataController',

    requires:[
        'Ext.Praxis.controller.sales.AccountingProcessConsortiaNoiata.DataEntryReverseAccountingProcessConsortiaNoiataController'
    ],
