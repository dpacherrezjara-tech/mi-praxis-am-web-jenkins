...
Ext.define('Ext.Praxis.view.sales.InvoiceCommissionConsortiaNoiataForm.DataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-dataEntry',
    controller: prototype.id + '-dataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.InvoiceCommissionConsortiaNoiata.DataEntryInvoiceCommissionConsortiaNoiataController'
    ],
    title: 'Invoice Commission Consortia No IATA',
    header: true,
    width: 600,
    height: 650,
    border: false,
