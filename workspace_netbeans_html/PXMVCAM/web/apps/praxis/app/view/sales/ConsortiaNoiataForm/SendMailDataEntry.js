...
Ext.define('Ext.Praxis.view.sales.ConsortiaNoiataForm.SendMailDataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-sendMailDataEntry',
    controller: prototype.id + '-sendMailDataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.ConsortiaNoiata.SendMailDataEntryConsortiaNoiataController'
    ],
    title: 'Send Mail',
    header: true,
    width: 700,
