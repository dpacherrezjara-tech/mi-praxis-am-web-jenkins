...
Ext.define('Ext.Praxis.view.sales.ConsortiaContractForm.SendMailDataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-sendMailDataEntry',
    controller: prototype.id + '-sendMailDataEntryController',
    requires: [
        'Ext.Praxis.controller.sales.ConsortiaContract.SendMailDataEntryConsortiaContractController'
    ],
    title: 'Send Mail',
    header: true,
    width: 700,
