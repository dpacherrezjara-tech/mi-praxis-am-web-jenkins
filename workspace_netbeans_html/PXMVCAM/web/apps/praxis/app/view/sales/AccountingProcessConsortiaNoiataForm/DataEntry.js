Ext.define('Ext.Praxis.view.sales.AccountingProcessConsortiaNoiataForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryAccountingProcessConsortiaNoiataForm',

    controller: 'DataEntryAccountingProcessConsortiaNoiataController',

    requires:[
        'Ext.Praxis.controller.sales.AccountingProcessConsortiaNoiata.DataEntryAccountingProcessConsortiaNoiataController'
    ],

    title:'Accounting Master Process No IATA- Data Entry Form',
    header:true,
    height:260,
    width:815,
    border:false,
