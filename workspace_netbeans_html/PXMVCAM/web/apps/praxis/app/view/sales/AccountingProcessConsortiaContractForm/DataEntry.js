Ext.define('Ext.Praxis.view.sales.AccountingProcessConsortiaContractForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryAccountingProcessConsortiaContractForm',

    controller: 'DataEntryAccountingProcessConsortiaContractController',

    requires:[
        'Ext.Praxis.controller.sales.AccountingProcessConsortiaContract.DataEntryAccountingProcessConsortiaContractController'
    ],

    title:'Accounting Master Process Contract- Data Entry Form',
    header:true,
    height:260,
    width:815,
    border:false,
