...
Ext.define('Ext.Praxis.view.eecta.AplicacionVentaPreForm.InfoGrid', {
...
//                            ],
                            ...
                            columns: {
                                items: [                                    
                                    {text: 'Nº Reporte', dataIndex: 'A4245NRRPT', width: 80, align: 'center', locked: true},
                                    {text: 'Id Cliente', dataIndex: 'A4245CDCLI', align: 'center', width: 80, locked: true},
                                    {text: 'Nombre Cliente', dataIndex: 'A3953RSOCI', align: 'left', width: 200, locked: true},
                                    {
                                        xtype: 'actioncolumn',
                                        text:'Detalle<br>Bolets',
                                        sortable: false,
                                        width: 55,
                                        align: 'center',
                                        locked: true,
                                    ...
                                    },
                                    {
                                        text: 'Periodo',
                                        columns: [
                                            {text: 'Desde', dataIndex: 'A4245INIPR', width: 70, align: 'left'},
                                            {text: 'Hasta', dataIndex: 'A4245FINPR', width: 70, align: 'left'}
                                        ]
                                    },
                                    {text: 'Mda.', dataIndex: 'A4245MDLOC', width: 50, align: 'center'},
                                    {text: 'Tarifa', dataIndex: 'A4245FARE', width: 90, align: 'right',
//                                        summaryType: 'sum',
...
//                                        },
                                    ...
                                    {
                                        text: 'Other', dataIndex: 'A4245OTR', width: 70, align: 'right',
//                                        summaryType: 'sum',
//                                        summaryRenderer: function (value, summaryData, dataIndex) {
//                                            return Ext.util.Format.number(value, '0,000.00');
//                                        },
...
//                                        },
                                    ...
                                    {
                                        text: 'Aplicado', dataIndex: 'A4245TOTAP', width: 90, align: 'right',
//                                        summaryType: 'sum',
//                                        summaryRenderer: function (value, summaryData, dataIndex) {
//                                            return Ext.util.Format.number(value, '0,000.00');
//                                        },
                                    ...
                                    {
                                        text: 'Saldo', dataIndex: 'A4245SALDP', width: 90, align: 'right',
//                                        summaryType: 'sum',
//                                        summaryRenderer: function (value, summaryData, dataIndex) {
//                                            return Ext.util.Format.number(value, '0,000.00');
//                                        },
                                    ...
                                    {text: 'Estado', dataIndex: 'A4245STSPG', width: 70, align: 'left'},
//                                    {text: 'Ref.', dataIndex: 'A4245REFBC', width: 70, align: 'left'},
