            ...
            items: [
                {
                    ...
                    items: [
                        {
                            xtype: 'textfield',
                            id: prototype.id05 + '-A4103IDRCB',
                            fieldLabel: 'Id Aplicacion', labelAlign: 'right', labelStyle: 'font-weight: bold;', labelWidth: 125,
                            ...
                            listeners: {
                                ...
                                keypress: function (obj, e) {
                                    if (e.getKey() === e.ENTER) {
                                        //Ext.getCmp(prototype.id05 + '-A3953CIUDA').focus();
                                    }
                                }
                            }
                        },
                        ...
                        },
                        {
                            ...
                            listeners: {
                                ...
                                keypress: function (obj, e) {
                                    if (e.getKey() === e.ENTER) {
                                        //Ext.getCmp(prototype.id05 + '-A3953NCOME').focus();
                                    }
                                }
                            }
                        }
