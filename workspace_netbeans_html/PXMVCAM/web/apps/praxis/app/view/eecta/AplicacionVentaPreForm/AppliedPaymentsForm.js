...
//console.log(prototype.id + '-appliedPaymentsController');

Ext.define('Ext.Praxis.view.eecta.AplicacionVentaPreForm.AppliedPaymentsForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id + '-AppliedPaymentsForm',
    controller: prototype.id + '-appliedPaymentsFormController',
    requires: [
        'Ext.Praxis.controller.eecta.AplicacionVentaPre.AppliedPaymentsController',
        'Ext.Praxis.view.eecta.AplicacionVentaPreForm.InfoGridAppliedPaymentCab',
        'Ext.Praxis.view.eecta.AplicacionVentaPreForm.InfoGridAppliedPaymentDet'
    ],
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            items: [
                                {
                                    xtype: 'textfield',
                                    id: prototype.id + '-A4245TOT',
                                    fieldLabel: 'Total', labelAlign: 'right', labelStyle: 'font-weight: bold;', labelWidth: 50,
                                    width: 160, fieldStyle: 'font-weight: bold;font-size:13px;text-align:right',
                                    value: '0.00',
                                    readOnly: true
                                },
                                {
                                    xtype: 'textfield',
                                    id: prototype.id + '-A4245MDLOC',
                                    padding: '0 0 0 2',
