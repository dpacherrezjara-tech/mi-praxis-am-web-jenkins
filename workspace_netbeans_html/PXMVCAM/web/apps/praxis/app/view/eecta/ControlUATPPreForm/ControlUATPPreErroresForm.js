...
Ext.define('Ext.Praxis.view.eecta.ControlUATPPreForm.ControlUATPPreErroresForm', {
    extend: 'Ext.window.Window',
    alias: 'widget.' + prototype.id04 + '-dataEntry',
    controller: prototype.id04 + '-controlUATPPreErroresController',
    requires: [
        'Ext.Praxis.controller.eecta.ControlUATPPre.ControlUATPPreErroresController',
        'Ext.Praxis.view.eecta.ControlUATPPreForm.Info03'
    ],
    title: 'Validaciones/Errores carga UATP',
    header: true,
    width: 800,
    height: 480,
    border: false,
