Ext.define('Ext.Praxis.view.eecta.AplicacionVentaPreForm.Filters', {
                                ...
                                // <editor-fold defaultstate="collapsed" desc="BoxFilter02">
                                {
                                    ...
                                    items: [
                                        ...
                                        },
                                        {
                                            ...
                                            fieldLabel: 'Nº Aplicacion', labelAlign: 'right', labelStyle: 'font-weight: bold;', labelWidth: 120,
                                            fieldStyle: 'text-align:left;font-weight: bold;font-size:13px;',
                                            enableKeyEvents: true,
                                            width: 210,
                                            height: 24,
                                        ...
                                        },
                                        {
                                            ...
                                            fieldLabel: 'Estado apl.', labelAlign: 'right', labelStyle: 'font-weight: bold;', labelWidth: 125,
