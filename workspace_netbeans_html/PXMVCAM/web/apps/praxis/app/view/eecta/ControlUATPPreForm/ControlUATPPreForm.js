...
prototype.id02 = 'ControlUATPPreProcesarForm';
...
Ext.define('Ext.Praxis.view.eecta.ControlUATPPreForm.ControlUATPPreForm', {
    ...
    alias: 'widget.ControlUATPPreForm',
    requires: [
        'Ext.Praxis.controller.eecta.ControlUATPPre.ControlUATPPreController',
        'Ext.Praxis.view.eecta.ControlUATPPreForm.Options',
        'Ext.Praxis.view.eecta.ControlUATPPreForm.Filters',
        'Ext.Praxis.view.eecta.ControlUATPPreForm.Info00',
        'Ext.Praxis.view.eecta.ControlUATPPreForm.Info01'
    ],
    controller: 'ControlUATPPreController',
