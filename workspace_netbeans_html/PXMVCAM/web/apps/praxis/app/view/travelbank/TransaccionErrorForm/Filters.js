Ext.define('Ext.Praxis.view.travelbank.TransaccionErrorForm.Filters', {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                // </editor-fold>                                 
                                // <editor-fold defaultstate="collapsed" desc="Ticked Number">
                                {
                                    xtype: 'panel',
                                    id: prototype.id + '-BoxTicketNumber',
                                    border: false,
                                    hidden: false,
                                    layout: 'hbox',
                                    bodyStyle: 'background: transparent;"',
                                    ...
                                    items: [
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id + '-TicketNumber',
                                            fieldLabel: 'Ticket Nbr.', labelAlign: 'right', labelStyle: 'font-weight: bold;', labelWidth: 100,
                                            fieldStyle: 'text-align:center;font-weight: bold;font-size:13px;',
                                            enableKeyEvents: true,
                                            enforceMaxLength: true,
                                            maxLength:13,
