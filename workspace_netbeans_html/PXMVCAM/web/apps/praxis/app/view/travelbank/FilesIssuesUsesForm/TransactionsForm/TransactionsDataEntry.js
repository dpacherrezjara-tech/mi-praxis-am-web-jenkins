Ext.define('Ext.Praxis.view.travelbank.FilesIssuesUsesForm.LiabilityForm.FileLiabilityDataEntry', {
    extend: 'Ext.window.Window',
    alias: 'widget.FileLiabilityDataEntryForm',
    controller: 'FileLiabilityDataEntryController',
    requires: [
        'Ext.Praxis.controller.travelbank.FilesIssuesUses.FileLiabilityDataEntryController'
    ],
    title: 'LIABILITY - Data entry',
    header: true,
    height: 450,
    width: 520,
    border: false,
    ...
    items: [
        {
            xtype: 'form',
            id: prototype.id20 + '-formDataEntry',
            defaults: {
                style: 'margin: 3px;',
                border: false
            },
...
//                                        }
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id20 + '-A4357BALNC',
                                            fieldLabel: 'Balance Remainin:', labelAlign: 'right', labelStyle: 'font-weight: bold;',
                                            labelWidth: 125, fieldStyle: 'text-align:right;font-size:13px',
                                            readOnly: false,
                                            width: 245
                                        }
