Ext.define('Ext.Praxis.view.travelbank.FilesIssuesUsesForm.ExpireForm.Filters', {
    extend: 'Ext.form.Panel',
    alias: 'widget.' + prototype.id11 + '-filters',
    border: false,
    ...
    items: [
        {
            ...
            items: [
                {
                    xtype: 'panel',
                    id: prototype.id11 + '-boxSearchFilter',
                    width: '100%',
                    layout: 'vbox',
                    border: false,
                    bodyStyle: 'background: transparent',
                            ...
                            items: [
                                ...
                                // <editor-fold defaultstate="collapsed" desc="BoxFilter02">
                                {
                                    ...
                                    items: [
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id11 + '-A4280IDFILE1',
                                        ...
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id11 + '-A4280IDFILE2',
