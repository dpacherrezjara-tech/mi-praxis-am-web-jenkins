Ext.define('Ext.Praxis.view.travelbank.DeliveryFilesForm.Filters', {
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                {xtype: 'tbspacer', width: 3},
                                {
                                    ...
                                    store: new Ext.data.SimpleStore({
                                        ...
                                        data: [
                                            ...
                                            ["MER", "Merged"],
                                            ["EXP", "Expired"],
                                            ["ALR", "Airline Liability Report"],
                                            ["LOS", "Airline Liability Losses"]
                                        ]
                                    }),
                                    queryMode: 'local',
                                    hiddenLabel: false,
                                ...
                                {
                                    xtype: 'label',
                                    html: '<strong>Nbr Identifier:</strong>',
                                    align: 'center',
                                    fieldStyle: 'text-align: center;',
                                    padding: '8px 7px 8px 0px'
                                },
