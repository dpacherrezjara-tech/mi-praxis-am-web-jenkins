Ext.define('Ext.Praxis.view.travelbank.AccountMasterTravelBankForm.DataEntry',{
    extend: 'Ext.window.Window',
    alias: 'widget.DataEntryAccountMasterTravelBankForm',

    controller: 'DataEntryAccountMasterTravelBankController',

    requires:[
        'Ext.Praxis.controller.travelbank.AccountMasterTravelBank.DataEntryAccountMasterTravelBankController'
    ],
