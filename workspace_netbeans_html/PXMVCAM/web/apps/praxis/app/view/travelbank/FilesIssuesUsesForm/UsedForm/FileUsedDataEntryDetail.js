Ext.define('Ext.Praxis.view.travelbank.FilesIssuesUsesForm.UsedForm.FileUsedDataEntryDetail', {
    extend: 'Ext.window.Window',
    alias: 'widget.FileUsedDataEntryDetailForm',
    controller: 'FileUsedDataEntryDetailController',
    requires: [
        'Ext.Praxis.controller.travelbank.FilesIssuesUses.FileUsedDataEntryDetailController',
        'Ext.Praxis.view.travelbank.FilesIssuesUsesForm.UsedForm.InfoDetailN2'
    ],
