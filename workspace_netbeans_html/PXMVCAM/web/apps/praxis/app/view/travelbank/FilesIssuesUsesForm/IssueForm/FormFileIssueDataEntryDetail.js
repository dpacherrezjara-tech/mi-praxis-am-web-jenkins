Ext.define('Ext.Praxis.view.travelbank.FilesIssuesUsesForm.IssueForm.FormFileIssueDataEntryDetail', {
    extend: 'Ext.window.Window',
    alias: 'widget.FormFileIssueDataEntryDetailForm',
    controller: 'FormFileIssueDataEntryDetailController',
    requires: [
        'Ext.Praxis.controller.travelbank.FilesIssuesUses.FormFileIssueDataEntryDetailController'
    ],
    title: 'ISSUES - Data entry detail',
    header: true,
    height: 450,
    width: 480,
    border: false,
    ...
    items: [
        {
            xtype: 'form',
            id: prototype.id05 + '-formDataEntry',
            defaults: {
                style: 'margin: 3px;',
                border: false
            },
                            ...
                            items: [
                                ...
                                },
                                {
                                    ...
                                    items: [
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id05 + '-ticket-number',
