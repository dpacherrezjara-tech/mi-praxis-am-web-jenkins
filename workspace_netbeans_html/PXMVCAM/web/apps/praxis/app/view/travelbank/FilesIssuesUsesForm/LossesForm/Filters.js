Ext.define('Ext.Praxis.view.travelbank.FilesIssuesUsesForm.LossesForm.Filters', {
    extend: 'Ext.form.Panel',
    alias: 'widget.' + prototype.id15 + '-filters',
    border: false,
    ...
    items: [
        {
            ...
            items: [
                {
                    xtype: 'panel',
                    id: prototype.id15 + '-boxSearchFilter',
                    width: '100%',
                    layout: 'vbox',
                    border: false,
                    bodyStyle: 'background: transparent',
                    ...
                    items: [
                        {
                            ...
                            items: [
                                ...
                                // <editor-fold defaultstate="collapsed" desc="Transaction ID">
                                {
                                    xtype: 'panel',
                                    id: prototype.id15 + '-BoxTransactionID',
                                    border: false,
                                    hidden: false,
                                    layout: 'hbox',
                                    bodyStyle: 'background: transparent;"',
                                    ...
                                    items: [
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id15 + '-A4347IDLOS',
                                            fieldLabel: 'Transacction ID', labelAlign: 'right', labelStyle: 'font-weight: bold;', labelWidth: 120,
                                ...
                                {
                                    xtype: 'panel',
                                    id: prototype.id15 + '-BoxTicketNumber',
                                    border: false,
                                    hidden: true,
                                    layout: 'hbox',
                                    bodyStyle: 'background: transparent;"',
                                    ...
                                    items: [
                                        {
                                            xtype: 'textfield',
                                            id: prototype.id15 + '-ticket',
                                            fieldLabel: 'Ticket Number', labelAlign: 'right', labelStyle: 'font-weight: bold;', labelWidth: 120,
                                            fieldStyle: 'text-align:center;font-weight: bold;font-size:13px;',
                                            enableKeyEvents: true,
                                            enforceMaxLength: true,
                                            maxLength: 13,
                                ...
                                {
                                    xtype: 'panel',
                                    id: prototype.id15 + '-BoxAccountNumber',
                                    border: false,
                                    hidden: true,
                                    layout: 'hbox',
                                    bodyStyle: 'background: transparent;"',
                                ...
                                {
                                    xtype: 'panel',
                                    id: prototype.id15 + '-BoxFechasDesdeHasta',
                                    border: false,
                                    hidden: true,
                                    layout: 'hbox',
                                    bodyStyle: 'background: transparent;"',
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                ...
                                                keypress: function (obj, e) {
                                                    if (e.getKey() === e.ENTER) {
                                                        Ext.getCmp(prototype.id15 + '-fecha2').focus();
                                                    }
                                                }
                                            }
                                        },
                                ...
                                {
                                    xtype: 'panel',
                                    id: prototype.id15 + '-BoxNbrIDENTIFIER',
                                    border: false,
                                    hidden: true,
                                    layout: 'hbox',
                                    bodyStyle: 'background: transparent;"',
