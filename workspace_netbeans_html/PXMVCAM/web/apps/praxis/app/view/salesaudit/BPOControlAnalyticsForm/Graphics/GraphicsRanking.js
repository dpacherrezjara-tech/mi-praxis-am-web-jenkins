    ...
    items: [{
            ...
            items: [
                ...
                // TAB 3: Gráfico Dual - OPTIMIZADO
                {
                    ...
                    tbar: {
                        style: 'background: linear-gradient(to right, #FACC15, #D97706); border: none; height: 35px;',
                        items: [
                            {
                                xtype: 'button',
                                iconCls: 'fa fa-download',
