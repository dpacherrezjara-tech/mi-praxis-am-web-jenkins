    ...
    items: [
        {
            ...
            columns: {
                ...
                items: [
                    ...
                    {
                        text: 'NMemo', dataIndex: 'A2548NMEMO', width: 100
                    },
                    {
                        text: 'Status', dataIndex: 'ESTADO', width: 100,
                        renderer: function (value, metaData, record, rowIndex, colIndex, store, view) {
                            const opts = {
                                'PENDING': { text: 'Pending', color: '#FFF9C4', textColor: '#F57F17' }, // amarillo
                            ...
                            if (status) {
                                metaData.style = `background-color: ${status.color}; color: ${status.textColor}; font-weight: bold; padding: 4px 8px; border-radius: 4px;`;
                                return status.text;
                            }
                            return value;
                        }
