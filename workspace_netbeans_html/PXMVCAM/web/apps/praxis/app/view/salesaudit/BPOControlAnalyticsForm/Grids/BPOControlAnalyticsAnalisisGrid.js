Ext.define('Ext.Praxis.view.salesaudit.BPOControlAnalyticsForm.Grids.BPOControlAnalyticsAnalisisGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.' + prototype.id + '-BPOControlAnalyticsAnalisisGrid',
    requires: [
        'Ext.Praxis.controller.salesaudit.BPOControlAnalytics.GridBPOControlAnalyticsAnalisisController'
    ],
