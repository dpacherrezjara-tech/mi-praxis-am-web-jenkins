Ext.define('Ext.Praxis.view.salesaudit.BPOControlAnalyticsForm.Grids.BPOControlAnalyticsRendimientoGrid', {
    extend: 'Ext.grid.Panel',
    alias: 'widget.' + prototype.id + '-BPOControlAnalyticsRendimientoGrid',

    requires: [
        'Ext.Praxis.controller.salesaudit.BPOControlAnalytics.GridBPOControlAnalyticsRendimientoController'
    ],
