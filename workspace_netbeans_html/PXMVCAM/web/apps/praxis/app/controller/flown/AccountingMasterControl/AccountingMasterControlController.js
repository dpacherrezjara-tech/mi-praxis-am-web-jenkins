...
Ext.define('Ext.Praxis.controller.flown.AccountingMasterControl.AccountingMasterControlController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountingMasterControlController',
    flightNumber: '',
    carrier: '',
    searchParams: {},
    me: '',
    ...
    init: function(view) {
        prototype.id = 'AccountingMasterControlForm';
        prototype.url = CONTEXTPATH + '/AccountingMasterControl';
        var me = this;
        this.control({
            // -------------------Eventos Genericos --------------------
            '#AccountingMasterControlForm-xpanel': {
                afterrender: this.xpanel_afterrender
            }
            ,
            '#AccountingMasterControlForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#AccountingMasterControlForm-btnClear': {
                click: this.btnClear_click
            },
            '#AccountingMasterControlForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#AccountingMasterControlForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#AccountingMasterControlForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#AccountingMasterControlForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#AccountingMasterControlForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#AccountingMasterControlForm-btn-pag-next': {
                click: this.pagNext
            },
            '#AccountingMasterControlForm-btn-pag-last': {
                click: this.pagLast
            },
            '#AccountingMasterControlForm-cboModulo': {
    ...
    setGridData: function(obj, val) {
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.flown.AccountingMasterControl.GridData', {
            proxy: {
    ...
    winDataEntry: function(action, rec, all, rowIndex) {
        ...
        Ext.create('Ext.Praxis.view.flown.AccountingMasterControlForm.DataEntry', {
            //id: prototype.id + '-dataEntry',
            id: 'DataEntryAccountingMasterControlForm',
            params: {
                action: action,
                rec: rec,
                all: all,
