...
//    beanOption: {},
    ...
    mostrarData: function(bean) {
        ...
        Ext.getCmp(prototype.id+"-txtDESCRIP").setValue(bean.strDescripcion.substring(0,70).trim());
        Ext.getCmp(prototype.id+"-txtDESCRIP2").setValue(bean.strDescripcion.substring(70,100).trim());
    ...
    llenarData: function(beanOption, strOption) {
        ...
        beanOption.strDescripcion = this.getValue('txtDESCRIP').padEnd(70, ' ') + this.getValue('txtDESCRIP2').padEnd(70, ' ');
