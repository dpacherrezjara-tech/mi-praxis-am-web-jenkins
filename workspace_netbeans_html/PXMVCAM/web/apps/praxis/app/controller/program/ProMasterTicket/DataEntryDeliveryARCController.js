Ext.define('Ext.Praxis.controller.program.ProMasterTicket.DataEntryDeliveryARCController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryDeliveryARCController',
    beanProMasterTicket: {},
    bean: {},
    Ticket_FUENTE: '',
    Ticket_TDNR: '',
    ...
    imgBack_clickHandler: function() {
        Ext.getCmp('DataEntryDeliveryARCForm').hide();
    },
    // </editor-fold>
...
//                            Ext.getCmp(prototype.id+'-1-lblPagActual').setText(currentPage);
    ...
    gridDataDeliveryARC_act1_clickHandler: function (column, e, row, column2, x) {
        var data = {};
	data = x.record.data;
        var cia = data.A4471CIA;
        var forma = data.A4471FORMA;
        var serie = data.A4471SERIE;
        ...
        bean.TDNR = TDNR;
        console.log(data);
        this.searchDeliveryARCDetail(bean,data.A4471STATU);
    },
    searchDeliveryARCDetail: function (bean,statustkt) {
        prototype.url = URL_VIEWTICKET;
        console.log(prototype.ProrrateoNew.url + '/searchDeliveryARCDetail');
        var me1 = this;
        Ext.Ajax.request({
            url: prototype.ProrrateoNew.url + '/searchDeliveryARCDetail',
            method: 'POST',
            timeout: 60000000,
    ...
    onCancelClick: function(btn){
        //this.view.hide();
        //me.dataEntryDelivery.hide();
        //var controller = me.dataEntryDelivery.getController();
        //Ext.getCmp(prototype.id+'-DataEntryDeliveryARCForm').destroy();
        console.log("esconder");
        me.dataEntryDelivery.hide();
        //console.log(me.dataEntryDelivery);
    },
