                ...
                try {
                    ...
                    $('.menu-logout').on('click', function(e) {
                        ...
                        $.get(url, function(data) {
                            ...
                            if (result === '1') {
                                sessionStorage.clear();
                                //Test: https://praxisamtesting.miatech.net/AUTH/logout/okta
                                //Local: http://localhost:8000/AUTH/logout/okta
                                window.location.href = "https://praxisam.miatech.net/AUTH/logout/okta";
                            }
                            ;
                        });
                    });
