...
Ext.define('Ext.Praxis.controller.eecta.CargaRecibos.CargaRecibosBatchController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id02 + '-cargaRecibosBatchController',
    ...
    crud: function () {
        ...
        form.submit({
            url: prototype.url + '/setCargaRecibosBatch',
            ...
            success: function (fp, o) {
                ...
                //Ext.getCmp(prototype.id + '-CargaRecibosBoletoEntry').unmask('Loading...', '');
                global.Msg({
