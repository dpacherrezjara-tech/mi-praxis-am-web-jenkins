Ext.define('Ext.Praxis.controller.eecta.AplicacionVentaPre.AplicacionVentaPreController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AplicacionVentaPreController',
    requires: [
        'Ext.Praxis.view.eecta.AplicacionVentaPreForm.InfoGrid'
    ],
    beanXLS: {},
    recGrid01: {},
    recGrid02: {},
...
//        });
    ...
    winDataEntry02:function (action, rec) {
        action = action === null || action === undefined ? 'U' : action;
        rec = rec === null || rec === undefined ? {} : rec;       
        Ext.create('Ext.Praxis.view.eecta.AplicacionVentaPreForm.AppliedPaymentsForm', {
