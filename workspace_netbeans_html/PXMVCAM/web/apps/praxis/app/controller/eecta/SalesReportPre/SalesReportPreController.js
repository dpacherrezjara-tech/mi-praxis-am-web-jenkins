Ext.define('Ext.Praxis.controller.eecta.SalesReportPre.SalesReportPreController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.SalesReportPreController',
    requires: [
       'Ext.Praxis.view.eecta.SalesReportPreForm.InfoGrid'
    ],
    beanXLS: {},
    recGrid01: {},
    recGrid02: {},
...
//        });
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.eecta.SalesList.GridData', {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A4245");
    ...
    onReportVentaUATP_PDF: function ( grid, rowIndex, colIndex ) {
        ...
        var bean = {};
        bean.VP_A4245NRRPT = this.gridData.get('A4245NRRPT');
        bean.VP_A4245CDCLI = this.gridData.get('A4245CDCLI');        
