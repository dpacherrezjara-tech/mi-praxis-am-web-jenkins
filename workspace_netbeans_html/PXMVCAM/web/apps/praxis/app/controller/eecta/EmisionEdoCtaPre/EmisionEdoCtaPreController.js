Ext.define('Ext.Praxis.controller.eecta.EmisionEdoCtaPre.EmisionEdoCtaPreController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.EmisionEdoCtaPreController',
    requires: [
       'Ext.Praxis.view.eecta.EmisionEdoCtaPreForm.InfoGrid'
    ],
    url: CONTEXTPATH + '/EmisionEdoCta', 
    beanXLS: {},
    recGrid01: {},
    recGrid02: {},
    recGrid03: {},
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.eecta.SalesList.GridData', {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A4258");
...
//                        });
    ...
    onReportEdoCta: function ( grid, rowIndex, colIndex ) {
        ...
        var bean = {};
        bean.VP_A4258NREDO = this.gridData.get('A4258NREDO');
...
//        this.exportPdf(prototype.url + '/pdf_EstadoCuenta_det/?beanString=' + encodeURI(JSON.stringify(bean)) );
    ...
    winDataEntry:function (action, rec) {
        ...
        Ext.create('Ext.Praxis.view.eecta.EmisionEdoCtaPeForm.ConsultaEdoCtaForm', {
