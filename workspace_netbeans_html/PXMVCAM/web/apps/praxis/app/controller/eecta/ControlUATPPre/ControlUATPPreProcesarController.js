...
Ext.define('Ext.Praxis.controller.eecta.ControlUATPPre.ControlUATPPreProcesarController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id02 + '-controlUATPPreProcesarController',
...
//        return;        
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp(prototype.id02 + '-ControlUATPPreProcesarForm').mask('Loading...', ''),
            success: function (response, options) {
                var res = Ext.JSON.decode(response.responseText);
                var objRtn = res.objRtn;
                Ext.getCmp(prototype.id02 + '-ControlUATPPreProcesarForm').unmask('Loading...', '');
                global.Msg({
                    ...
                    fn: function () {
                        ...
                        var elem = document.getElementById('ControlUATPPreProcesarForm_Msg');
    ...
    onCancelClick: function (btn) {
        Ext.getCmp(prototype.id02 + '-ControlUATPPreProcesarForm').close();
    },     
