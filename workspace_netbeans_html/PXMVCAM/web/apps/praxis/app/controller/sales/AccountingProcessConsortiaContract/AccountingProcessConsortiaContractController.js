Ext.define('Ext.Praxis.controller.sales.AccountingProcessConsortiaContract.AccountingProcessConsortiaContractController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountingProcessConsortiaContractController',
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.sales.AccountingProcessConsortiaContractForm.DataEntry', {
            id: 'DataEntryAccountingProcessConsortiaContractForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.AccountingProcessConsortiaContract.GridData', {
            proxy: {
