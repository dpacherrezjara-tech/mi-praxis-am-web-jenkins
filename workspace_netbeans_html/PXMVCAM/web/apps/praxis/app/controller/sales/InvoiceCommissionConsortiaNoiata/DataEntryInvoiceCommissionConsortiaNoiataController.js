...
Ext.define('Ext.Praxis.controller.sales.InvoiceCommissionConsortiaNoiata.DataEntryInvoiceCommissionConsortiaNoiataController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id + '-dataEntryController',
    url: CONTEXTPATH + '/InvoiceCommissionConsortiaNoiata',
    lblPreffixOld: '',
    /**
     * Constructor
     */
...
//            Ext.getCmp(prototype.id + '-txtA1757IVACB_P').setValue(Ext.util.Format.number(data.A2444IVA16, '0,000.00'));    //COLHDG('IVA COMM BANCARIA')
    ...
    crud: function () {
        ...
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp(prototype.id + '-DataEntryInvoiceCommissionConsortiaNoiataForm').mask('Loading...', ''),
            success: function (response, options) {
                var res = Ext.JSON.decode(response.responseText);
                var objRtn = res.objRtn;
                console.log(objRtn);
                Ext.getCmp(prototype.id + '-DataEntryInvoiceCommissionConsortiaNoiataForm').unmask('Loading...', '');
                global.Msg({
                    msg: objRtn.dbException.MESSAGE,
                    icon: 1,
                    fn: function () {
                        //exito
                        Ext.getCmp(prototype.id + '-DataEntryInvoiceCommissionConsortiaNoiataForm').close();
