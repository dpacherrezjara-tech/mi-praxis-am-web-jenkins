Ext.define('Ext.Praxis.controller.sales.AccountingProcessFob.DataEntryAccountingProcessFobController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryAccountingProcessFobController',
...
//                Ext.getCmp(prototype.id + '-obj').focus();
    ...
    mostrarData: function(rec) {
        ...
        switch (rec.get('A1955MODUL')) {
            case 'PCONSORTIA': case 'PFLOWN': case 'PADJMA': case "PPCONSORTIA" : case "PFOB":  
                Ext.getCmp(prototype.id+'-boxFecha').show();
    ...
    crud: function() {
        ...
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryAccountingProcessFobForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD INSERTED') {
                                Ext.getCmp('DataEntryAccountingProcessFobForm').close(),
                ...
                Ext.getCmp('DataEntryAccountingProcessFobForm').unmask();
            },
    ...
    setReverse: function(objDT){
        Ext.Ajax.request({
            ...
            success: function(response, options) {
                var res = Ext.JSON.decode(response.responseText);
                if (res.success) {                    
                    Ext.create('Ext.Praxis.view.sales.AccountingProcessFobForm.DataEntryReverse', {
                        id: 'DataEntryReverseAccountingProcessFobForm',
                        params: {
                            rec: res.data,
                            obj: objDT.data
                        }
