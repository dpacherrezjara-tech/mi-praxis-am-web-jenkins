Ext.define('Ext.Praxis.controller.sales.AccountingProcessConsortiaNoiata.AccountingProcessConsortiaNoiataController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountingProcessConsortiaNoiataController',
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.sales.AccountingProcessConsortiaNoiataForm.DataEntry', {
            id: 'DataEntryAccountingProcessConsortiaNoiataForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.AccountingProcessConsortiaNoiata.GridData', {
            proxy: {
