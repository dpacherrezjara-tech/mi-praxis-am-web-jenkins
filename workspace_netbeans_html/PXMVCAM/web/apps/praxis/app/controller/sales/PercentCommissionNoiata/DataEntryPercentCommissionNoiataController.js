...
Ext.define('Ext.Praxis.controller.sales.PercentCommissionNoiata.DataEntryPercentCommissionNoiataController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.' + prototype.id + '-dataEntryController',
    url: CONTEXTPATH + '/PercentCommissionNoiata',
    lblPreffixOld: '',
    /**
     * Constructor
     */
    ...
    crud: function() {
        ...
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp(prototype.id + '-DataEntryPercentCommissionNoiataForm').mask('Loading...', ''),
            success: function(response, options) {
                var res = Ext.JSON.decode(response.responseText);
                var objRtn = res.objRtn;
                console.log(objRtn);
                Ext.getCmp(prototype.id + '-DataEntryPercentCommissionNoiataForm').unmask('Loading...', '');
                global.Msg({
                    msg: objRtn.dbException.MESSAGE,
                    icon: 1,
                    fn: function() {
                        //exito
                        Ext.getCmp(prototype.id + '-DataEntryPercentCommissionNoiataForm').close();
