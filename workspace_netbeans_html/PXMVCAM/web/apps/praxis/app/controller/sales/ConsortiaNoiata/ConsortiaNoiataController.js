...
Ext.define('Ext.Praxis.controller.sales.ConsortiaNoiata.ConsortiaNoiataController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ConsortiaNoiataController',
    fecha: new Date(),
    paginActual: '',
    drillDown: [],
    gridActual: '',
    ...
    init: function(view) {
        ...
        this.control({
            // -------------------Eventos Genericos --------------------
            '#ConsortiaNoiataForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#ConsortiaNoiataForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#ConsortiaNoiataForm-btnClear': {
                click: this.btnClear_click
            },
            '#ConsortiaNoiataForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#ConsortiaNoiataForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#ConsortiaNoiataForm-btnBack': {
                click: this.btnBack_click
            },
            '#ConsortiaNoiataForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#ConsortiaNoiataForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ConsortiaNoiataForm-btn-pag-next': {
                click: this.pagNext
            },
            '#ConsortiaNoiataForm-btn-pag-last': {
                click: this.pagLast
            },
            //-----------------Eventos Especificos -------------------            
            '#ConsortiaNoiataForm-cmbDate': {
                change: this.onChangeSearch
            },
            '#ConsortiaNoiataForm-txtIata': {
                keyup: this.eventKey,
                change: this.onUpperValue
            },
            '#ConsortiaNoiataForm-txtIata_02': {
                keyup: this.eventKey,
                change: this.onUpperValue
            },
            '#ConsortiaNoiataForm-txtLote': {
                keyup: this.eventKey,
                change: this.onUpperValue
            }
        });
