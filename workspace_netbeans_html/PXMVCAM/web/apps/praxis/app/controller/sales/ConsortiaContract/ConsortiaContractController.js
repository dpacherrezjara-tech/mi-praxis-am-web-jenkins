...
Ext.define('Ext.Praxis.controller.sales.ConsortiaContract.ConsortiaContractController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ConsortiaContractController',
    fecha: new Date(),
    paginActual: '',
    drillDown: [],
    gridActual: '',
    ...
    init: function(view) {
        ...
        this.control({
            // -------------------Eventos Genericos --------------------
            '#ConsortiaContractForm-xpanel': {
                afterrender: this.xpanel_afterrender
            },
            '#ConsortiaContractForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#ConsortiaContractForm-btnClear': {
                click: this.btnClear_click
            },
            '#ConsortiaContractForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#ConsortiaContractForm-btnFilter': {
                click: this.btnFilter_click
            },
            '#ConsortiaContractForm-btnBack': {
                click: this.btnBack_click
            },
            '#ConsortiaContractForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#ConsortiaContractForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ConsortiaContractForm-btn-pag-next': {
                click: this.pagNext
            },
            '#ConsortiaContractForm-btn-pag-last': {
                click: this.pagLast
            },
            //-----------------Eventos Especificos -------------------            
            '#ConsortiaContractForm-cmbDate': {
                change: this.onChangeSearch
            },
            '#ConsortiaContractForm-txtIata': {
                keyup: this.eventKey,
                change: this.onUpperValue
            },
            '#ConsortiaContractForm-txtIata_02': {
                keyup: this.eventKey,
                change: this.onUpperValue
            },
            '#ConsortiaContractForm-txtLote': {
                keyup: this.eventKey,
                change: this.onUpperValue
            }
        });
