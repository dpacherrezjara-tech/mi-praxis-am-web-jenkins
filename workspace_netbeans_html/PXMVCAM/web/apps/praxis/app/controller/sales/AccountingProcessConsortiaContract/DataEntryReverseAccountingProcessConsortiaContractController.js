Ext.define('Ext.Praxis.controller.sales.AccountingProcessConsortiaContract.DataEntryReverseAccountingProcessConsortiaContractController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryReverseAccountingProcessConsortiaContractController',
    ...
    crud: function() {
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryReverseAccountingProcessConsortiaContractForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD REMOVED') {
                                Ext.getCmp('DataEntryReverseAccountingProcessConsortiaContractForm').close();
                ...
                Ext.getCmp('DataEntryReverseAccountingProcessConsortiaContractForm').unmask();
            },
