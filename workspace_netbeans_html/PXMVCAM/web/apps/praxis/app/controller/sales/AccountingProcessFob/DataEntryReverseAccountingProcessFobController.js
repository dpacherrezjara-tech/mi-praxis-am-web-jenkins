Ext.define('Ext.Praxis.controller.sales.AccountingProcessFob.DataEntryReverseAccountingProcessFobController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryReverseAccountingProcessFobController',
    ...
    crud: function() {
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryReverseAccountingProcessFobForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD REMOVED') {
                                Ext.getCmp('DataEntryReverseAccountingProcessFobForm').close();
                ...
                Ext.getCmp('DataEntryReverseAccountingProcessFobForm').unmask();
            },
