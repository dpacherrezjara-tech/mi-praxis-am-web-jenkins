...
Ext.define('Ext.Praxis.controller.sales.ConsortiaContract.DataEntryConsortiaContractController', {
    ...
    init: function(view) {
        console.log("init");
        prototype.id = 'ConsortiaContractForm';
        prototype.url = CONTEXTPATH + '/ConsortiaContract';
        this.control({
            // -------------------Eventos Genericos --------------------            
            '#ConsortiaContractForm-de-btnSearch': {
                click: this.btnSearch_click
            },
            '#ConsortiaContractForm-de-btnClear': {
                click: this.btnClear_click
            },
            '#ConsortiaContractForm-de-btnExcel': {
                click: this.btnExcel_click
            },
            '#ConsortiaContractForm-de-btnFilter': {
                click: this.btnFilter_click
            },
            '#ConsortiaContractForm-de-btnBack': {
                click: this.btnBack_click
            },
            '#ConsortiaContractForm-de-btn-pag-first': {
                click: this.pagFirst
            },
            '#ConsortiaContractForm-de-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ConsortiaContractForm-de-btn-pag-next': {
                click: this.pagNext
            },
            '#ConsortiaContractForm-de-btn-pag-last': {
                click: this.pagLast
            },
            //-----------------Eventos Especificos -------------------            
            '#ConsortiaContractForm-de-cmbOptionTKT': {
                change: this.onChangeSearch
            },
            '#ConsortiaContractForm-de-BtnSendMailFOB': {
                click: this.onBtnSendMailFOB
            },
            '#ConsortiaContractForm-de-BtnAcuseFOB': {
    ...
    setGridData: function(obj, val) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.ConsortiaContract.GridData', {
            proxy: {
    ...
    onViewDetailClick: function(obj, metaData, rowNum, columnNum, obj2, rowData) {
        ...
        var dataEntry = Ext.create('Ext.Praxis.view.sales.ConsortiaContractForm.DataEntry', {
    ...
    onBtnSendMailFOB: function() {
        var p = this.view.params;
        var rec = p.rec;
        var sendMailDataEntry = Ext.create('Ext.Praxis.view.sales.ConsortiaContractForm.SendMailDataEntry', {
    ...
    onBtnAcuseFOB: function() {
        var p = this.view.params;
        var rec = p.rec;
        var acuseFOBDataEntry = Ext.create('Ext.Praxis.view.sales.ConsortiaContractForm.AcuseFOBDataEntry', {
