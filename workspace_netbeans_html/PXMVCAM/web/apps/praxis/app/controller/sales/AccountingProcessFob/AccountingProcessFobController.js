Ext.define('Ext.Praxis.controller.sales.AccountingProcessFob.AccountingProcessFobController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountingProcessFobController',
...
//        this.btnSearch_click();
    ...
    onEditClick: function(grid, rowIndex, colIndex) {
        ...
        console.log(rec);
        //if(rec.data.A1955MODUL!=='PFOB')
        this.winDataEntry('U', rec);
    },
    winDataEntry: function(action, rec) {
        action = action === null || action === undefined ? 'U' : action;
        rec = rec === null || rec === undefined ? {} : rec;
        Ext.create('Ext.Praxis.view.sales.AccountingProcessFOBForm.DataEntry', {
            id: 'DataEntryAccountingProcessFOBForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.AccountingProcessFob.GridData', {
            proxy: {
