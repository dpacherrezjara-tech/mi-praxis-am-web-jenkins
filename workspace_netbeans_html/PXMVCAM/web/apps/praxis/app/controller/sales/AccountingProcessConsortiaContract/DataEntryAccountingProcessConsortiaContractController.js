Ext.define('Ext.Praxis.controller.sales.AccountingProcessConsortiaContract.DataEntryAccountingProcessConsortiaContractController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryAccountingProcessConsortiaContractController',
...
//                Ext.getCmp(prototype.id + '-obj').focus();
    ...
    crud: function() {
        ...
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryAccountingProcessConsortiaContractForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD INSERTED') {
                                Ext.getCmp('DataEntryAccountingProcessConsortiaContractForm').close(),
                ...
                Ext.getCmp('DataEntryAccountingProcessConsortiaContractForm').unmask();
            },
    ...
    setReverse: function(objDT){
        Ext.Ajax.request({
            ...
            success: function(response, options) {
                var res = Ext.JSON.decode(response.responseText);
                if (res.success) {                    
                    Ext.create('Ext.Praxis.view.sales.AccountingProcessConsortiaContractForm.DataEntryReverse', {
                        id: 'DataEntryReverseAccountingProcessConsortiaContractForm',
                        params: {
                            rec: res.data,
                            obj: objDT.data
                        }
