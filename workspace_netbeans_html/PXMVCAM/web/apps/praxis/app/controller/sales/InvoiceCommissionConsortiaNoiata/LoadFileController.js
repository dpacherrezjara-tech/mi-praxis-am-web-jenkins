Ext.define('Ext.Praxis.controller.sales.InvoiceCommissionConsortiaNoiata.LoadFileController',{
                    ...
                    Ext.MessageBox.alert('PRAXIS', msj, function (btn, text) {
                        if (btn === 'ok' || btn === 'cancel'){
                            if (SQLCODE==="0") {
                                ...
                                Ext.create('Ext.Praxis.view.sales.InvoiceCommissionConsortiaNoiataForm.LoadErrorFile', {
                                    id: 'LoadErrorFileInvoiceCommissionConsortiaNoiataForm',
                                    params: {
                                        data: MESSAGE
                                    }
                                }).show();
