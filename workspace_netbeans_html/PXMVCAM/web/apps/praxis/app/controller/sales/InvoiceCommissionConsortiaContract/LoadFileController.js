Ext.define('Ext.Praxis.controller.sales.InvoiceCommissionConsortiaContract.LoadFileController',{
                    ...
                    Ext.MessageBox.alert('PRAXIS', msj, function (btn, text) {
                        if (btn === 'ok' || btn === 'cancel'){
                            if (SQLCODE==="0") {
                                ...
                                Ext.create('Ext.Praxis.view.sales.InvoiceCommissionConsortiaContractForm.LoadErrorFile', {
                                    id: 'LoadErrorFileInvoiceCommissionConsortiaContractForm',
                                    params: {
                                        data: MESSAGE
                                    }
                                }).show();
