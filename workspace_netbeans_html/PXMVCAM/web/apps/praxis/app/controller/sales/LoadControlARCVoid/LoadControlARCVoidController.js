Ext.define('Ext.Praxis.controller.sales.LoadControlARCVoid.LoadControlARCVoidController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.LoadControlARCVoidController',
    //<editor-fold defaultstate="collapsed" desc="Variables Globales">
    ControlFormatARCVoid: Ext.create('Ext.Praxis.view.program.CtrlControlFormatARCVoidForm', { id: 'CtrlControlFormatARCVoidForm' }),
    ControlLoadARCVoid: Ext.create('Ext.Praxis.view.program.CtrlControlLoadARCVoidForm', { id: 'CtrlControlLoadARCVoidForm' }),
    searchParams: {},
    me: '',
    IdFile: '',
    beanErrorFormat: {},
    ...
    init: function(view) {
        ...
        prototype.id = 'LoadControlARCVoidForm';
    ...
    loadHOT: function(beanHOT) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.GridData', {
            proxy: {
                ...
                load: function(obj) {
                    win.lblUser_toolTip("Estructura: A4470/A4471");
    ...
    processFormatARCHOT: function (bean) {
        var me1 = this;
        Ext.Ajax.request({
            url: prototype.url+'/processFormatARCVOID',
            method: 'POST',
            timeout: 60000000,
            params: {beanString: JSON.stringify(bean)},
            beforerequest: Ext.getCmp('CtrlControlFormatARCVoidForm').mask('Loading...'),
            success: function (response, opts) {
                Ext.getCmp('CtrlControlFormatARCVoidForm').unmask();
                var res = Ext.JSON.decode(response.responseText);
                if (res.success) {
                    me1.gloFilterFormatARCHOT = res.filter;
                    var controller = me1.ControlFormatARCVoid.getController();
    ...
    processLoadARCHOT: function (bean) {
        var me1 = this;
        Ext.Ajax.request({
            url: prototype.url+'/processLoadARCVOID',
            method: 'POST',
            timeout: 60000000,
            params: {beanString: JSON.stringify(bean)},
            beforerequest: Ext.getCmp('CtrlControlLoadARCVoidForm').mask('Loading...'),
            success: function (response, opts) {
                Ext.getCmp('CtrlControlLoadARCVoidForm').unmask();
                var res = Ext.JSON.decode(response.responseText);
                if (res.success) {
                    me1.gloFilterARCHOT = res.filter;
                    var controller = me1.ControlLoadARCVoid.getController();
