...
Ext.define('Ext.Praxis.controller.sales.SalesReport.DataEntryGroupController', {
    ...
    setStoreData: function () {
        ...
        let cmbTransactionRftx = Ext.getCmp(prototype.idGr + '-de-cmbOptionRftx');
        cmbTransactionRftx.bindStore(Ext.create('Ext.data.ArrayStore', {
            autoLoad: false,
            fields: ['code', 'name'],
            data: [
                ["2", "Ticket"],
                                    ...
                                    columns: [
                                        {
                                            ...
                                            renderer: function (value, metaData, record, rowIndex, colIndex) {
                                                switch (record.data.LINK_DETAIL2) {
                                                    case 'A':
                                                        metaData.style = "text-align:right;font-weight:bold;color:#0000FF;";
                                                        break;
                                                    case 'B':
                                                        metaData.style = "text-align:right;font-weight:bold;color:#008000;";
                                                        break;
                                                    case 'C':
                                        ...
                                        },
                                        {
                                            ...
                                            renderer: function (value, metaData, record, rowIndex, colIndex, store) {
                                                if (record.data.LINK_DETAIL2 === 'C')
                                                    return '<img src="resources/img/botones/16x16/application_view_detail.png">';
                                                else
                                                    return '';
                                            }
                                        },
    ...
    onClickBtnSearch: function () {
        ...
        switch (meDE.tabId) {
            ...
            case '3':
                ...
                break;
            case '4':
                meDE.paramsDE.IN_OPCION = Ext.getCmp(prototype.idGr + '-de-cmbOptionRftx').getValue();
                break;
        }
        this.btnSearch_click();
    },
    btnSearch_click: function () {
        ...
        switch (meDE.tabId) {
            ...
            case '4':
                ...
                meDE.paramsDE.IN_IATA = Ext.getCmp(prototype.idGr + '-de-txtRftxIata').getValue();
                break;
        }
...
// </editor-fold>
    ...
    onChangeComboRftx: function (obj, val) {
        switch (val) {
            case '2':
                Ext.getCmp(prototype.idGr + '-de-txtRftxNumber').show();
                Ext.getCmp(prototype.idGr + '-de-txtRftxIata').hide();
                break;
            case '3':
                Ext.getCmp(prototype.idGr + '-de-txtRftxNumber').hide();
                Ext.getCmp(prototype.idGr + '-de-txtRftxIata').show();
                break;
        }
    },
