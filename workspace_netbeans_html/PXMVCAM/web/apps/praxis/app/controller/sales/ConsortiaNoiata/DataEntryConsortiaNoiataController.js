...
Ext.define('Ext.Praxis.controller.sales.ConsortiaNoiata.DataEntryConsortiaNoiataController', {
    ...
    init: function(view) {
        console.log("init");
        prototype.id = 'ConsortiaNoiataForm';
        prototype.url = CONTEXTPATH + '/ConsortiaNoiata';
        this.control({
            // -------------------Eventos Genericos --------------------            
            '#ConsortiaNoiataForm-de-btnSearch': {
                click: this.btnSearch_click
            },
            '#ConsortiaNoiataForm-de-btnClear': {
                click: this.btnClear_click
            },
            '#ConsortiaNoiataForm-de-btnExcel': {
                click: this.btnExcel_click
            },
            '#ConsortiaNoiataForm-de-btnFilter': {
                click: this.btnFilter_click
            },
            '#ConsortiaNoiataForm-de-btnBack': {
                click: this.btnBack_click
            },
            '#ConsortiaNoiataForm-de-btn-pag-first': {
                click: this.pagFirst
            },
            '#ConsortiaNoiataForm-de-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#ConsortiaNoiataForm-de-btn-pag-next': {
                click: this.pagNext
            },
            '#ConsortiaNoiataForm-de-btn-pag-last': {
                click: this.pagLast
            },
            //-----------------Eventos Especificos -------------------            
            '#ConsortiaNoiataForm-de-cmbOptionTKT': {
                change: this.onChangeSearch
            },
            '#ConsortiaNoiataForm-de-BtnSendMailFOB': {
                click: this.onBtnSendMailFOB
            },
            '#ConsortiaNoiataForm-de-BtnAcuseFOB': {
    ...
    setGridData: function(obj, val) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.sales.ConsortiaNoiata.GridData', {
            proxy: {
    ...
    onViewDetailClick: function(obj, metaData, rowNum, columnNum, obj2, rowData) {
        ...
        var dataEntry = Ext.create('Ext.Praxis.view.sales.ConsortiaNoiataForm.DataEntry', {
    ...
    onBtnSendMailFOB: function() {
        var p = this.view.params;
        var rec = p.rec;
        var sendMailDataEntry = Ext.create('Ext.Praxis.view.sales.ConsortiaNoiataForm.SendMailDataEntry', {
    ...
    onBtnAcuseFOB: function() {
        var p = this.view.params;
        var rec = p.rec;
        var acuseFOBDataEntry = Ext.create('Ext.Praxis.view.sales.ConsortiaNoiataForm.AcuseFOBDataEntry', {
