Ext.define('Ext.Praxis.controller.sales.AccountingProcessConsortiaNoiata.DataEntryReverseAccountingProcessConsortiaNoiataController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryReverseAccountingProcessConsortiaNoiataController',
    ...
    crud: function() {
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryReverseAccountingProcessConsortiaNoiataForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD REMOVED') {
                                Ext.getCmp('DataEntryReverseAccountingProcessConsortiaNoiataForm').close();
                ...
                Ext.getCmp('DataEntryReverseAccountingProcessConsortiaNoiataForm').unmask();
            },
