Ext.define('Ext.Praxis.controller.sales.AccountingProcessConsortiaNoiata.DataEntryAccountingProcessConsortiaNoiataController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryAccountingProcessConsortiaNoiataController',
...
//                Ext.getCmp(prototype.id + '-obj').focus();
    ...
    crud: function() {
        ...
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryAccountingProcessConsortiaNoiataForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD INSERTED') {
                                Ext.getCmp('DataEntryAccountingProcessConsortiaNoiataForm').close(),
                ...
                Ext.getCmp('DataEntryAccountingProcessConsortiaNoiataForm').unmask();
            },
    ...
    setReverse: function(objDT){
        Ext.Ajax.request({
            ...
            success: function(response, options) {
                var res = Ext.JSON.decode(response.responseText);
                if (res.success) {                    
                    Ext.create('Ext.Praxis.view.sales.AccountingProcessConsortiaNoiataForm.DataEntryReverse', {
                        id: 'DataEntryReverseAccountingProcessConsortiaNoiataForm',
                        params: {
                            rec: res.data,
                            obj: objDT.data
                        }
