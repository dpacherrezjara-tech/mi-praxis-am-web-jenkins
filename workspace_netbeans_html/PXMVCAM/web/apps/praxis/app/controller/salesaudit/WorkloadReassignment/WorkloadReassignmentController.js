Ext.define('Ext.Praxis.controller.salesaudit.WorkloadReassignment.WorkloadReassignmentController', {
    ...
    init: function (view) {
        ...
        this.control({
            ...
            '#WorkloadReassignmentForm-btnAsigna': {
                click: this.onChangeAsignaClick
            }
        });
    },
    ...
    obtainData: async function () {
        ...
        Ext.getCmp(prototype.id + '-txtFilterDateFrom').setValue(Ext.Date.format(new Date(), 'Y/m/d'));
        Ext.getCmp(prototype.id + '-txtFilterDateTo').setValue(Ext.Date.format(new Date(), 'Y/m/d'));
    },
    onChangeAsignaClick: async function () {
        var me = this;
        ...
        global.Msg({
            msg: 'Are you sure Automatic Assignment ?',
            icon: 3,
            buttons: 3,
            fn: async function (btn) {      // ← async aquí es el fix
                if (btn === 'yes') {
                    ...
                    try {
                        const res = await global.callStorePost('PXSAUDIT', 'SQP06037', params);
    ...
    OnDetail02: async function () {
        ...
        await me.onLoadUsersDetail(); // ✅ sin argumento
    },
    OnDetail01: async function (rowIndex) {
        ...
        Ext.getCmp(prototype.id + '-btnAsigna').hide();
    ...
    onChangeAuditorClick: function (obj) {
        ...
        Ext.create('Ext.Praxis.view.salesaudit.WorkloadReassignmentForm.DataEntryAsigna', {
            params: {
                ...
                IN_DATE: me.beantmpdetaill.IN_DATE,
                IN_SOURCE: me.beantmpdetaill.IN_SOURCE,
                IN_COUNTRY: me.beantmpdetaill.IN_COUNTRY
            }
        }).show();
    },
