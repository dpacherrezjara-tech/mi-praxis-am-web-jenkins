Ext.define('Ext.Praxis.controller.panel.ProfilesManagement.ProfilesManagementController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ProfilesManagementController',
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.panel.ProfilesManagementForm.DataEntry', {
            id: 'DataEntryProfilesManagementForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.panel.ProfilesManagement.GridData', {
            proxy: {
            ...
            listeners: {
                ...
                load: function(obj, obj2, success, obj4, obj5) {
                    win.lblUser_toolTip("Estructura: A4846");
