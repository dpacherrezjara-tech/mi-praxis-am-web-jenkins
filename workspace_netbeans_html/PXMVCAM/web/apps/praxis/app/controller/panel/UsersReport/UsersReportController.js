Ext.define('Ext.Praxis.controller.panel.UsersReport.UsersReportController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.UsersReportController',
    ...
    init: function(view) {
        ...
        prototype.id = 'UsersReportForm';
        prototype.url = CONTEXTPATH+'/UsersReport';
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.panel.UsersReportForm.DataEntry', {
            id: 'DataEntryUsersReportForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.panel.UsersReport.GridData', {
            proxy: {
