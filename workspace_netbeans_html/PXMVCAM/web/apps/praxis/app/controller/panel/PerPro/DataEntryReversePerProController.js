Ext.define('Ext.Praxis.controller.panel.PerPro.DataEntryReversePerProController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryReversePerProController',
    ...
    crud: function() {
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryReversePerProForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD REMOVED') {
                                Ext.getCmp('DataEntryReversePerProForm').close();
                ...
                Ext.getCmp('DataEntryReversePerProForm').unmask();
            },
