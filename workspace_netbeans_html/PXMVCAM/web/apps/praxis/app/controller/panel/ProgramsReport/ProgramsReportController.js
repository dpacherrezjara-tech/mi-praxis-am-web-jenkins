Ext.define('Ext.Praxis.controller.panel.ProgramsReport.ProgramsReportController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ProgramsReportController',
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.panel.ProgramsReportForm.DataEntry', {
            id: 'DataEntryProgramsReportForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.panel.ProgramsReport.GridData', {
            proxy: {
