    Ext.define('Ext.Praxis.controller.payments.ReconciliationPaymentTicket.DataEntryReconciliationPaymentTicketController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryReconciliationPaymentTicketController',
    bean: {},
    lstA2290: {},
    lstCards: {},
    actionCode: '',
    ...
    viewDataEntry: function (e, b, c) {
        ...
        if (this.lstA2290 !== undefined) {
            ...
            if(beanCons !== undefined && beanCons.strTicket !== ''){
                me.searchBean(beanCons, 'DataEntryReconciliationPaymentTicketForm');
            } else {
