Ext.define('Ext.Praxis.controller.payments.ReconciliationPaymentTicket.DataEntryTicketReconciliationPaymentTicketController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryTicketReconciliationPaymentTicketController',
    bean: {},
    lista: {},
    lstCards: [],
    actionCode: '',
...
//                }
    ...
    mostrarData: function () {
        ...
        win.setValue("2-txtUSOS1", this.bean.USOS1.trim());
        win.setValue("2-txtUSOS2", this.bean.USOS2.trim());
        win.setValue("2-txtUSOS3", this.bean.USOS3.trim());
        win.setValue("2-txtUSOS4", this.bean.USOS4.trim());
    ...
    MaintenanceAdjustA4164: function (beanTemp) {
        ...
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp(prototype.id + '-DataEntryTicketReconciliationPaymentTicketForm').mask('Loading...'),
            success: function (response, opts) {
                Ext.getCmp(prototype.id + '-DataEntryTicketReconciliationPaymentTicketForm').unmask('Loading...');
                var res = Ext.JSON.decode(response.responseText);
//                console.log(res);
                if (res.success) {
                    Ext.getCmp(prototype.id + '-DataEntryTicketReconciliationPaymentTicketForm').unmask();
                } else {
...
//                console.log(res);
                if (res.success) {
                    Ext.getCmp(prototype.id + '-DataEntryTicketReconciliationPaymentTicketForm').unmask();
                    Ext.getCmp(prototype.id + '-DataEntryTicketReconciliationPaymentTicketForm').close();
                } else {
                    global.Msg({msg: res.msjOption});
                }
            }
