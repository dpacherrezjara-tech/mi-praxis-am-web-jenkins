Ext.define('Ext.Praxis.controller.payments.AccountingProcessCharger.DataEntryReverseAccountingProcessChargerController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryReverseAccountingProcessChargerController',
    ...
    crud: function() {
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryReverseAccountingProcessChargerForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD REMOVED') {
                                Ext.getCmp('DataEntryReverseAccountingProcessChargerForm').close();
                ...
                Ext.getCmp('DataEntryReverseAccountingProcessChargerForm').unmask();
            },
