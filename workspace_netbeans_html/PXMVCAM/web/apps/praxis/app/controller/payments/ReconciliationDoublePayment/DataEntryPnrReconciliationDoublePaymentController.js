Ext.define('Ext.Praxis.controller.payments.ReconciliationDoublePayment.DataEntryPnrReconciliationDoublePaymentController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryPnrReconciliationDoublePaymentController',
...
//        Ext.getCmp(prototype.id + '-dataEntryPnr').hide();
...
//        console.log(beanString);
        ...
        Ext.Ajax.request({
            ...
            method: 'POST',
            timeout: 60000000,
            beforerequest: Ext.getCmp(prototype.id + '-dataEntryPnr').mask('Loading...'),
            params: {beanString: beanString},
            success: function(response, options) {
                Ext.getCmp(prototype.id + '-dataEntryPnr').unmask('Loading...');
                var res = Ext.JSON.decode(response.responseText);
//                console.log(res);
...
//                console.log(res);
                ...
                if (res.success) {
                    ...
                    Ext.getCmp(prototype.id + '-dataEntryPnr').unmask();
                    Ext.getCmp(prototype.id + '-dataEntryPnr').close();
