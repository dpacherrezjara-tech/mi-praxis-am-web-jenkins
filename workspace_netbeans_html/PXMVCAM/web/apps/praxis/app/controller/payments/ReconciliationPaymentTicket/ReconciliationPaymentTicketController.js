Ext.define('Ext.Praxis.controller.payments.ReconciliationPaymentTicket.ReconciliationPaymentTicketController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.ReconciliationPaymentTicketController',
    stack: [],
    bean: {},
    beanDetailTkt: {},
    beanDetailTar: {},
    ...
    init: function (view) {
        me = this;
        prototypeProgram.view = 'payments-reconciliation-payment-ticket-form';
        prototypeProgram.nprog = 'PX00000621';
        prototypeProgram.title = 'Reconciliation Payment by Ticket';
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.payments.GridData', {
            ...
            listeners: {
                ...
                load: function (obj, obj2, success, response, obj5) {
                    ...
                    win.lblUser_toolTip("Estructura: A4337AK");
...
//                load: function (obj, obj2, success, response, obj5) {
//                    Ext.getCmp(prototype.id + '-contentInfo').unmask();
//                    win.lblUser_toolTip("Estructura: A4338");
//
    ...
    searchDetCountry: function (beanDet) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.payments.GridData', {
            ...
            listeners: {
                ...
                load: function (obj, obj2, success, response, obj5) {
                    Ext.getCmp(prototype.id + '-contentInfo').unmask();
                    win.lblUser_toolTip("Estructura: A4337");
    ...
    searchWarnTkts: function (bean) {
        Ext.Ajax.request({
            ...
            success: function (response, opts) {
                ...
                var res = Ext.JSON.decode(response.responseText);
                if (res.success) {
                    var lstA4337 = res.lstWarnTkt;

                    if (lstA4337 !== undefined && lstA4337.length > 0) {
                        var DataEntry = Ext.create('Ext.Praxis.view.payments.ReconciliationPaymentTicketForm.DataEntry', {
                            id: 'DataEntryReconciliationPaymentTicketForm'
                        });
                        var controller = DataEntry.getController();
                        controller.lstA4337 = lstA4337;
            ...
            success: function (response, opts) {
                ...
                if (res.success) {
                    ...
                    if (beanCons !== undefined && beanCons.strTicket !== '') {
                        var DataEntryTicket = Ext.create('Ext.Praxis.view.payments.ReconciliationPaymentTicketForm.DataEntryTicket', {
                            id: prototype.id + '-DataEntryTicketReconciliationPaymentTicketForm'
                        });
