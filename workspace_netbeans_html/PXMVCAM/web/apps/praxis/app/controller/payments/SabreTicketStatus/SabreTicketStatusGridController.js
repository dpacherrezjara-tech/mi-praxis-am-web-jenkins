Ext.define('Ext.Praxis.controller.payments.SabreTicketStatus.SabreTicketStatusGridController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.SabreTicketStatusGridController',
    init: function (view) {
    },
 ...
 afterRender: function () {
    ...
    getData: function (view) {
        ...
        const store = global.callStorePaggin('PRAXISMP', 'SQP05709', view.searchParams);
