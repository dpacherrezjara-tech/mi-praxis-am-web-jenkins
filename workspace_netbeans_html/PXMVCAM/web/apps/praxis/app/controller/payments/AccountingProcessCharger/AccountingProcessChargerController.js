Ext.define('Ext.Praxis.controller.payments.AccountingProcessCharger.AccountingProcessChargerController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountingProcessChargerController',
...
//        this.btnSearch_click();
    ...
    winDataEntry: function(action, rec) {
        ...
        Ext.create('Ext.Praxis.view.payments.AccountingProcessChargerForm.DataEntry', {
            id: 'DataEntryAccountingProcessChargerForm',
            params: {
                action: action,
                rec: rec
            }
    ...
    setFormatParameter: function() {
        ...
        switch (cboModulo) {
            case 'PSALES': case 'PFLOWN': case 'PADJMA': case 'PCADUCOS': case 'PPSALES': case 'PADM': case 'PFOB': case 'PCONSORTIA': case 'PCHARGER': case 'PSETTLE':
    ...
    setGridData: function() {
        var storeGridDatas = Ext.create('Ext.Praxis.store.payments.AccountingProcessCharger.GridData', {
            proxy: {
