Ext.define('Ext.Praxis.controller.payments.BankEmissorCatalog.BankEmissorCatalogController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.BankEmissorCatalogController',
    ...
    loadBanks: async function () {
        ...
        mainPanel.removeAll();
        const panelDetail = Ext.create('Ext.Praxis.view.payments.BankEmissorCatalogForm.Grids.BanksGrid', {
            id: prototype.id + '-BanksGrid-1',
            url: me.url,
            searchParams: params
        });
    ...
    //<editor-fold defaultstate="collapsed" desc="Hanlders">
    onClickSearchBtn: function () {
        this.loadBanks();
    },
    onAddBankBtn: function () {
