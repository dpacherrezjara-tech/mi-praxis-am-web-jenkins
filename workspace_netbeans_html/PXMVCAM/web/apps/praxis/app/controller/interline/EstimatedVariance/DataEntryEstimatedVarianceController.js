Ext.define('Ext.Praxis.controller.interline.EstimatedVariance.DataEntryEstimatedVarianceController',{
    extend: 'Ext.app.ViewController',
    alias: 'controller.DataEntryEstimatedVarianceController',
    ...
    crud: function() {
        Ext.Ajax.request({
            ...
            beforerequest: Ext.getCmp('DataEntryEstimatedVarianceForm').mask('Loading...'),
            success: function(response, options) {
                    ...
                    global.Msg({
                        ...
                        fn: function() {
                            if (msg==='RECORD INSERTED' || msg==='RECORD REMOVED') {
                                Ext.getCmp('DataEntryEstimatedVarianceForm').close(),
                ...
                Ext.getCmp('DataEntryEstimatedVarianceForm').unmask();
            },
