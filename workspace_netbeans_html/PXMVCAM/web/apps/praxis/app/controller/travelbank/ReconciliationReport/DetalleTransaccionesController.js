...
Ext.define('Ext.Praxis.controller.travelbank.ReconciliationReport.DetalleTransaccionesController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.DetalleTransaccionesController',
...
//        }
    ...
    mostrarData: function (rec) {
        ...
        this.setValue('NCTA', rec.get('A4467CUENT'));
        this.setValue('CRDID', rec.get('A4467CRDID'));
        this.setValue('MDA', rec.get('A4467MONED'));
        this.setValue('SERV', rec.get('A4467SERVC'));
        this.setValue('FEMIS', rec.get('A4467FEMIS'));
        this.setValue('EXPDT', rec.get('A4467EXPDT'));
        
        this.setValue('AORIG', Ext.util.Format.number(rec.get('A4467AORIG'), '0,000.00'));
        this.setValue('AUSAD', Ext.util.Format.number(rec.get('A4467AUSAD'), '0,000.00'));
        this.setValue('ABALR', Ext.util.Format.number(rec.get('A4467ABALR'), '0,000.00'));
    ...
    setFormatParameter: function (rec) {
        ...
        me.searchParams = {
            ...
            VP_FECHA1: '',
            VP_FECHA2: '',
            VP_ACCNBR: rec.get('A4467CUENT'),
            VP_CREDID: rec.get('A4467CRDID')
        };        
    ...
    setGridData: function () {
        ...
        var storeGridDatas = Ext.create('Ext.Praxis.store.travelbank.AccountingMasterTravelbank.GridData', {
            proxy: {
                url: prototype.url2 + '/searchTransactionId'
            },
            listeners: {
