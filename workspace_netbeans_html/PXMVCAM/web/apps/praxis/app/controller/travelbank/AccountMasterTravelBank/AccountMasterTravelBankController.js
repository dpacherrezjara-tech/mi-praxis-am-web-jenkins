Ext.define('Ext.Praxis.controller.travelbank.AccountMasterTravelBank.AccountMasterTravelBankController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.AccountMasterTravelBankController',
    searchParams: {},
    init: function(view) {
        prototype.id = 'AccountMasterTravelBankForm';
        prototype.url = CONTEXTPATH + '/AccountMasterTravelBank';
        prototype.widthContenedor = 1500;
        prototype.widthGrid = 1459;
       
        var me = this;
        this.control({
            '#AccountMasterTravelBankForm-btn-pag-first': {
                click: this.pagFirst
            },
            '#AccountMasterTravelBankForm-btn-pag-previous': {
                click: this.pagPrevious
            },
            '#AccountMasterTravelBankForm-btn-pag-next': {
                click: this.pagNext
            },
            '#AccountMasterTravelBankForm-btn-pag-last': {
                click: this.pagLast
            },
            '#AccountMasterTravelBankForm-btnSearch': {
                click: this.btnSearch_click
            },
            '#AccountMasterTravelBankForm-btnFilter': {
                click: this.btnFilter_click
            },
////            '#AccountMasterTravelBankForm-btnDisplay': {
////                click: this.btnDisplay_click
////            },
            '#AccountMasterTravelBankForm-btnExcel': {
                click: this.btnExcel_click
            },
            '#AccountMasterTravelBankForm-btnClear': {
                click: this.btnClear_click
            },
            '#AccountMasterTravelBankForm-btnAdd': {
                click: this.btnAdd_click
            },
            '#AccountMasterTravelBankForm-btnBack': {
...
//    },
    ...
    setGridData: function(obj, val) {
        var storeGridDatas = Ext.create('Ext.Praxis.store.travelbank.AccountMasterTravelBank.GridData', {
            proxy: {
