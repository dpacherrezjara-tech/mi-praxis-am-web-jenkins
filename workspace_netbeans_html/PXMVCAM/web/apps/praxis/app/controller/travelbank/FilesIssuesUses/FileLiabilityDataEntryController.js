Ext.define('Ext.Praxis.controller.travelbank.FilesIssuesUses.FileLiabilityDataEntryController', {
    extend: 'Ext.app.ViewController',
    alias: 'controller.FileLiabilityDataEntryController',
...
//                Ext.getCmp(prototype.id20+'-btn-save').hide();
//                Ext.getCmp(prototype.id20+'-btn-update').hide();
//                if(this.p.rec.data.ESTADO === 'Error'){
//                    Ext.getCmp(prototype.id20+'-btn-delete').show();
//                }else{
//                    Ext.getCmp(prototype.id20+'-btn-delete').hide();
//                }                            
//                Ext.getCmp(prototype.id20+'-btn-cancel').show();
                break;
//            case 'I':
//                Ext.getCmp(prototype.id20+'-btn-save').show();
//                Ext.getCmp(prototype.id20+'-btn-update').hide();
//                Ext.getCmp(prototype.id20+'-btn-delete').hide();
//                Ext.getCmp(prototype.id20+'-btn-cancel').show();
//                break;
...
//        // <editor-fold defaultstate="collapsed" desc="DataHeader">        
        this.setValue('A4357IDMER', rec.get('A4357IDMER'));        
        //this.setValue('A4347TRNCU', rec.get('A4347TRNCU'));
        this.setValue('A4357NCTAT', rec.get('A4357NCTAT'));
        this.setValue('A4357SERV', rec.get('A4357SERV'));
        
        this.setValue('A4357MDA', rec.get('A4357MDA'));
        this.setValue('A4357VALOR', Ext.util.Format.number(rec.get('A4357VALOR'), '0,000.00'));
        this.setValue('A4357BALNC', Ext.util.Format.number(rec.get('A4357BALNC'), '0,000.00'));        
        this.setValue('A4357TIPD', rec.get('A4357TIPD'));   
                
        this.setValue('A4357FEMI', rec.get('A4357FEMI'));
        this.setValue('A4357FEXP', rec.get('A4357FEXP'));
        
        this.setValue('A4357PCONT', rec.get('A4357PCONT'));
        this.setValue('A4357FCONT', rec.get('A4357FCONT'));        
        this.setValue('A4357TYPE', rec.get('A4357TYPE'));
        this.setValue('A4357IDFIL', rec.get('A4357IDFIL'));
        
//        //Accounting & Audit Data        
        this.setValue('A4357REGIS', rec.get('A4357REGIS'));
        this.setValue('A4357FREGI', rec.get('A4357FREGI'));
        this.setValue('A4357HREGI', rec.get('A4357HREGI'));
        this.setValue('A4357REVIS', rec.get('A4357REVIS'));
        this.setValue('A4357FREVI', rec.get('A4357FREVI'));
        this.setValue('A4357HREVI', rec.get('A4357HREVI'));
//        // </editor-fold>         
    ...
    setFormatParameter: function (rec) {
        ...
        switch (cmbfiltro) {
            case "1" :
                me.detalleSearchParams.VP_IDISS = Ext.getCmp(prototype.id20 + '-A4347IDISS-Filter').getValue();
                break;
            case '2':
                me.detalleSearchParams.VP_Document = Ext.getCmp(prototype.id20 + '-DocumentTKT-Filter').getValue();
                break;
            case '3':
                me.detalleSearchParams.VP_IDISS = Ext.getCmp(prototype.id20 + '-A4347IDISR-Filter').getValue();
                break;
        }
        // </editor-fold>
...
//                                        Ext.getCmp(prototype.id20 + '-btnSearch').fireEvent('click', {});
//                            }
//                        }
//                    });
//                } else {
...
//        });
    ...
    getValue: function (id) {
        return Ext.getCmp(prototype.id20 + '-' + id).getValue();
    },
    focus: function (id) {
        Ext.getCmp(prototype.id20 + '-' + id).focus();
    },
    setValue: function (id, txt) {
        Ext.getCmp(prototype.id20 + '-' + id).setValue(txt);
    },
    ...
    llenarData: function () {
        ...
        switch (this.getValue('cbxModulo')) {
            ...
            case "PTBREPORT" :
            case "PTBDETAIL" :
                IN_FECHA_PROCESO = Ext.util.Format.date(Ext.getCmp(prototype.id20 + '-txtProcessDate').getValue(), 'Ymd');
                break;
