...
//        Ext.getCmp(prototype.id02+'-cmbDatePeriodFrom').setValue('');
//        Ext.getCmp(prototype.id02+'-cmbDatePeriodTo').setValue('');
//        var mes = new Date().getMonth()+1;
//        if(mes < 10) mes = "0"+mes;
//        Ext.getCmp(prototype.id02+'-cmbDateMonthFrom').setValue(mes);
//        Ext.getCmp(prototype.id02+'-cmbDateMonthTo').setValue(mes);
//        Ext.getCmp(prototype.id02+'-cmbDateYearFrom').setValue(new Date().getFullYear());
//        Ext.getCmp(prototype.id02+'-cmbDateYearTo').setValue(new Date().getFullYear());
//        // </editor-fold>
