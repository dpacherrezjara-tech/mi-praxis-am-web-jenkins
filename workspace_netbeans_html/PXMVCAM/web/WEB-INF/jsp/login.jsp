...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <%
            String issuer = "https://integrator-7732299.okta.com/oauth2/default";
            String clientId = "0oauokoov4OLsYxv3697";
            String redirectUri = "http://localhost:8080/AEROMEXICO/Auth";
                        ...
                        <table align="center" border="0" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td colspan="3" align="" valign="middle" height="40"><!--buttonLogin-->
                                                            <div style="margin-left:30%;">
                                                                <button class="btnlogin" style="width: 80%">
                                                                    <a href="https://praxisam.miatech.net/AUTH" style="text-decoration: none;color:white;">Log in GATEONE</a>
                                                                </button>
                                                            <input type="button" name="Submit" id="Submit" value="Sign In" class="btnlogin" style="display: none">
                            ...
                            <tr>
                                <td width="766" align="center" id="tfooter" class="txtFooter" height="30">
                                    2026 © Copyright Miami Technology Group,Inc. Rights reserved. v2.0
                                </td>
                            </tr>
                        </tbody></table>
                    </td>
