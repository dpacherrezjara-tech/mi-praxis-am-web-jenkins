            ...
            vhtml+='<div class="mt-calendar">';
               vhtml+='<div class="mt-header" align="right">';
                    ...
                    vhtml+='<div>';
                        ...
                        vhtml+='<div style="width: 65px;"></div>';
                        vhtml+='<div class="mt-bg-day" style="background-color: #E5ECEF">';
                            vhtml+='<div style="width: 134px;">Cycles 5 & 6 are Null</div>';
                        vhtml+='</div>';
                        vhtml+='<div style="width: 65px;"></div>';
                        vhtml+='<div style="width: 65px;">CAT</div>';
                        vhtml+='<div style="width: 75px;">Disbursement</div>';
                        ...
                        Ext.Object.each(value01.MONTHS, function(index02, value02){
                            vhtml+='<div>';
                                ...
                                Ext.Object.each(value02.WK, function(index03, value03){
                                    data01 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-WEEK' + '-' + value03.WEEK_COMMELW + '-' + value03.WEEK_COMMIAP + '-' + value03.WEEK_COMMIAR + '-' + value03.WEEK_CANT + '-' + value03.WEEK_ERROR + '-' + value03.WEEK_CANTSALE + '-' + value03.WEEK_CANTELW + '-' + value03.WEEK_CANTIAP + '-' + value03.WEEK_CANTIAR + '-' + value03.WEEK )
                                    data02 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-PED' + '-' + value03.PED_COMMELW + '-' + value03.PED_COMMIAP + '-' + value03.PED_COMMIAR + '-' + value03.PED_CANT + '-' + value03.PED_ERROR + '-' + value03.PED_CANTSALE + '-' + value03.PED_CANTELW + '-' + value03.PED_CANTIAP + '-' + value03.PED_CANTIAR + '-' + value03.PED )
                                    data03 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-WEDNESDAY' + '-' + value03.WEDNESDAY_COMMELW + '-' + value03.WEDNESDAY_COMMIAP + '-' + value03.WEDNESDAY_COMMIAR + '-' + value03.WEDNESDAY_CANT + '-' + value03.WEDNESDAY_ERROR + '-' + value03.WEDNESDAY_CANTSALE + '-' + value03.WEDNESDAY_CANTELW + '-' + value03.WEDNESDAY_CANTIAP + '-' + value03.WEDNESDAY_CANTIAR + '-' + value03.WEDNESDAY )
                                    data04 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-THURSDAY' + '-' + value03.THURSDAY1_COMMELW + '-' + value03.THURSDAY1_COMMIAP + '-' + value03.THURSDAY1_COMMIAR + '-' + value03.THURSDAY1_CANT + '-' + value03.THURSDAY1_ERROR + '-' + value03.THURSDAY1_CANTSALE + '-' + value03.THURSDAY1_CANTELW + '-' + value03.THURSDAY1_CANTIAP + '-' + value03.THURSDAY1_CANTIAR + '-' + value03.THURSDAY1 )
                                    data05 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-FRIDAY' + '-' + value03.FRIDAY_COMMELW + '-' + value03.FRIDAY_COMMIAP + '-' + value03.FRIDAY_COMMIAR + '-' + value03.FRIDAY_CANT + '-' + value03.FRIDAY_ERROR + '-' + value03.FRIDAY_CANTSALE + '-' + value03.FRIDAY_CANTELW + '-' + value03.FRIDAY_CANTIAP + '-' + value03.FRIDAY_CANTIAR + '-' + value03.FRIDAY )
                                    data06 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-SATURDAY' + '-' + value03.SATURDAY_COMMELW + '-' + value03.SATURDAY_COMMIAP + '-' + value03.SATURDAY_COMMIAR + '-' + value03.SATURDAY_CANT + '-' + value03.SATURDAY_ERROR + '-' + value03.SATURDAY_CANTSALE + '-' + value03.SATURDAY_CANTELW + '-' + value03.SATURDAY_CANTIAP + '-' + value03.SATURDAY_CANTIAR + '-' + value03.SATURDAY )
                                    data07 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-SUNDAY' + '-' + value03.SUNDAY_COMMELW + '-' + value03.SUNDAY_COMMIAP + '-' + value03.SUNDAY_COMMIAR + '-' + value03.SUNDAY_CANT + '-' + value03.SUNDAY_ERROR + '-' + value03.SUNDAY_CANTSALE + '-' + value03.SUNDAY_CANTELW + '-' + value03.SUNDAY_CANTIAP + '-' + value03.SUNDAY_CANTIAR + '-' + value03.SUNDAY )
                                    data08 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-MONDAY' + '-' + value03.MONDAY_COMMELW + '-' + value03.MONDAY_COMMIAP + '-' + value03.MONDAY_COMMIAR + '-' + value03.MONDAY_CANT + '-' + value03.MONDAY_ERROR + '-' + value03.MONDAY_CANTSALE + '-' + value03.MONDAY_CANTELW + '-' + value03.MONDAY_CANTIAP + '-' + value03.MONDAY_CANTIAR + '-' + value03.MONDAY )
                                    data09 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-WEDNESDAY1' + '-' + value03.WEDNESDAY_COMMELW + '-' + value03.WEDNESDAY_COMMIAP + '-' + value03.WEDNESDAY_COMMIAR + '-' + value03.WEDNESDAY_CANT + '-' + value03.WEDNESDAY_ERROR + '-' + value03.WEDNESDAY_CANTSALE + '-' + value03.WEDNESDAY_CANTELW + '-' + value03.WEDNESDAY_CANTIAP + '-' + value03.WEDNESDAY_CANTIAR + '-' + value03.WEDNESDAY )
                                    data10 = ( value.VALOR + '-' + value02.VALOR + '-' + value03.WEEK + '-WEDNESDAY2' + '-' + value03.WEDNESDAY_COMMELW + '-' + value03.WEDNESDAY_COMMIAP + '-' + value03.WEDNESDAY_COMMIAR + '-' + value03.WEDNESDAY_CANT + '-' + value03.WEDNESDAY_ERROR + '-' + value03.WEDNESDAY_CANTSALE + '-' + value03.WEDNESDAY_CANTELW + '-' + value03.WEDNESDAY_CANTIAP + '-' + value03.WEDNESDAY_CANTIAR + '-' + value03.WEDNESDAY )
                                   ...
                                   vhtml+='<div>';
                                        vhtml+='<div style="width: 35px; border-left: 1px solid #6CB6E7;"><a name="link-item-calendar" id="' + 'link-' + ( data01 ) + '" href="#" style="' + me.getColor(value03.WEEK_COLOR) + '" >' + value03.WEEK + '</a></div>';
                                        vhtml+='<div style="width: 65px;"><a name="link-item-calendar" id="' + 'link-' + ( data02 ) + '" href="#" style="' + me.getColor(value03.PED_COLOR) + '" >' + value03.PED + '</a></div>';
                                        vhtml+='<div style="width: 65px; color: #339900;"><a name="link-item-calendar" id="' + 'link-' + ( data03 ) + '" href="#" style="' + me.getColor(value03.WEDNESDAY_COLOR) + '" >' + value03.WEDNESDAY + '</a></div>';
                                        vhtml+='<div style="width: 65px; color: #339900;"><a name="link-item-calendar" id="' + 'link-' + ( data04 ) + '" href="#" style="' + me.getColor(value03.THURSDAY1_COLOR) + '" >' + value03.THURSDAY1 + '</a></div>';
                                        vhtml+='<div style="width: 65px; color: #339900;"><a name="link-item-calendar" id="' + 'link-' + ( data05 ) + '" href="#" style="' + me.getColor(value03.FRIDAY_COLOR) + '" >' + value03.FRIDAY + '</a></div>';
